...
public class ImageShineFilter extends AbstractImageFilter {
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        ImageErodeAlphaFilter s = new ImageErodeAlphaFilter(bevel * 10, 0.75f, 0.1f);
        ...
        g.drawRenderedImage(matte, null);
        g.dispose();
        shineLayer = new ImageGaussianFilter(radius).filter(shineLayer, null);
        shineLayer = new ImageRescaleFilter(3 * brightness).filter(shineLayer, shineLayer);
