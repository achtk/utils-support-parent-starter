 ...
 * 以更快但质量较低的方式产生运动模糊的过滤器。
 *
 * @author Administrator
 */
public class AbstractImageMotionBlurOp extends AbstractImageFilter {
     ...
     */
    public AbstractImageMotionBlurOp() {
    }
     ...
     */
    public AbstractImageMotionBlurOp(float distance, float angle, float rotation, float zoom) {
