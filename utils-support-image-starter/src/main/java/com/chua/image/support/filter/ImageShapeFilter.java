...
public class ImageShapeFilter extends ImageWholeImageFilter {
    ...
    private final static int SQRT_2 = (int) (41 * Math.sqrt(2));
    private final static int SQRT_5 = (int) (41 * Math.sqrt(5));
...
//				map[offset] = b * one;
    ...
    private int setEdgeValue(int x, int y, int[] map, int width, int offset, int xmax, int ymax) {
        ...
        if (y == 0 || x == 0 || y == ymax + TWE || x == xmax + TWE) {
