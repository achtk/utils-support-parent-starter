...
@Spi("Shadow")
@SpiOption("阴影滤镜")
public class ImageShadowFilter extends AbstractImageFilter {
     ...
     */
    public ImageShadowFilter(float radius, float xOffset, float yOffset, float opacity) {
        this.radius = radius;
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        shadow = new ImageGaussianFilter(radius).filter(shadow, null);
