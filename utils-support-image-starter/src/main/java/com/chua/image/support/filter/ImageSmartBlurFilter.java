 ...
 */
public class ImageSmartBlurFilter extends AbstractImageFilter {

    private int radiusH = 5;
    private int radiusV = 5;
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        Kernel kernel = ImageGaussianFilter.makeKernel(radiusH);
     ...
     * @see #getRadiusH
     */
    public void setRadiusH(int hRadius) {
        this.radiusH = hRadius;
    }
    ...
    public void setRadius(int radius) {
        this.radiusH = this.radiusV = radius;
    }
     ...
     * @see #getRadiusV
     */
    public void setRadiusV(int vRadius) {
        this.radiusV = vRadius;
    }
