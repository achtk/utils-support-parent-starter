...
public class ImageEdgeFilter extends ImageWholeImageFilter {
    ...
    protected float[] edgeMatrixV = SOBEL_V;
    protected float[] edgeMatrixH = SOBEL_H;

    public ImageEdgeFilter() {
    }

    public float[] getEdgeMatrixH() {
        return edgeMatrixH;
    }

    public void setEdgeMatrixH(float[] hEdgeMatrix) {
        this.edgeMatrixH = hEdgeMatrix;
    }

    public float[] getEdgeMatrixV() {
        return edgeMatrixV;
    }

    public void setEdgeMatrixV(float[] vEdgeMatrix) {
        this.edgeMatrixV = vEdgeMatrix;
    }
            ...
            for (int x = 0; x < width; x++) {
                ...
                for (int row = -1; row <= 1; row++) {
                    ...
                    for (int col = -1; col <= 1; col++) {
                        ...
                        float h = edgeMatrixH[moffset + col];
                        float v = edgeMatrixV[moffset + col];
