...
@Spi("ColorHalftone")
@SpiOption("像素化滤镜")
public class ImageColorHalftoneFilter extends AbstractImageFilter {
    ...
    public ImageColorHalftoneFilter() {
    }
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        for (int y = 0; y < height; y++) {
            ...
            for (int channel = 0; channel < THIRD; channel++) {
                ...
                for (int x = 0; x < width; x++) {
                    ...
                    for (int i = 0; i < FIVE; i++) {
                        ...
                        float dx2 = dx * dx;
                        float dy2 = dy * dy;
                        float sqrt = (float) Math.sqrt(dx2 + dy2);
                        float f2 = 1 - ImageMath.smoothStep(sqrt, sqrt + 1, l);
                        f = Math.min(f, f2);
                    }
