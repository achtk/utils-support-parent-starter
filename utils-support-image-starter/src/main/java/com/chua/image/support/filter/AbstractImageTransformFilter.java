...
/**
 * 以某种方式扭曲图像的过滤器的抽象超类。子类只需要重写
 * 两个方法来提供源像素和目标像素之间的映射。
 *
 * @author Administrator
 */
public abstract class AbstractImageTransformFilter extends AbstractImageFilter {
    ...
    public BufferedImage filter(BufferedImage src, BufferedImage dst) {
        ...
        if (dst == null) {
            ...
            dst = new BufferedImage(colorModel, colorModel.createCompatibleWritableRaster(transformedSpace.width, transformedSpace.height), colorModel.isAlphaPremultiplied(), null);
        }
