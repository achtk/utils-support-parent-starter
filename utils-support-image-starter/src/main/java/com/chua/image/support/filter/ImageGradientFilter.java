...
@Spi("Gradient")
@SpiOption("梯度滤镜")
public class ImageGradientFilter extends AbstractImageFilter {
    ...
    public ImageGradientFilter(Point p1, Point p2, int color1, int color2, boolean repeat, int type, int interpolation) {
        this.p1 = p1;
        this.p2 = p2;
        this.color1 = color1;
        this.color2 = color2;
