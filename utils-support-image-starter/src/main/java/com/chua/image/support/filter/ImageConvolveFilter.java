...
@Spi("Convolve")
@SpiOption("卷积核滤镜")
public class ImageConvolveFilter extends AbstractImageFilter {
     ...
     */
    public ImageConvolveFilter(float[] matrix) {
     ...
     */
    public ImageConvolveFilter(int rows, int cols, float[] matrix) {
     ...
     */
    public ImageConvolveFilter(Kernel kernel) {
        this.kernel = kernel;
    }
