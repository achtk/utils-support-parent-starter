 ...
 */
public class ImageRotateFilter extends AbstractImageTransformFilter {
     ...
     */
    public ImageRotateFilter(float angle) {
        this(angle, true);
    }
     ...
     */
    public ImageRotateFilter(float angle, boolean resize) {
        setAngle(angle);
        this.resize = resize;
    }
