 ...
 */
public class ImagePolarFilter extends AbstractImageTransformFilter {
     ...
     */
    public ImagePolarFilter(int type) {
        this.type = type;
        setEdgeAction(CLAMP);
    }
