...
public class ImageMath {
     ...
     * Catmull-Rom splines
     */
    private final static float M_00 = -0.5f;
    private final static float M_01 = 1.5f;
    private final static float M_02 = -1.5f;
    private final static float M_03 = 0.5f;
    private final static float M_10 = 1.0f;
    private final static float M_11 = -2.5f;
    private final static float M_12 = 2.0f;
    private final static float M_13 = -0.5f;
    private final static float M_20 = -0.5f;
    private final static float M_21 = 0.0f;
    private final static float M_22 = 0.5f;
    private final static float M_23 = 0.0f;
    private final static float M_30 = 0.0f;
    private final static float M_31 = 1.0f;
    private final static float M_32 = 0.0f;
    private final static float M_33 = 0.0f;
    ...
    public static int colorSpline(float x, int numKnots, int[] knots) {
        ...
        for (int i = 0; i < FOUR; i++) {
            ...
            c3 = M_00 * k0 + M_01 * k1 + M_02 * k2 + M_03 * k3;
            c2 = M_10 * k0 + M_11 * k1 + M_12 * k2 + M_13 * k3;
            c1 = M_20 * k0 + M_21 * k1 + M_22 * k2 + M_23 * k3;
            c0 = M_30 * k0 + M_31 * k1 + M_32 * k2 + M_33 * k3;
    ...
    public static void resample(int[] source, int[] dest, int length, int offset, int stride, float[] out) {
        int i = 0, j, a, r, g, b, nextA, nextR, nextG, nextB, srcIndex = offset, destIndex = offset, lastIndex = source.length, rgb;
        float sizfac, inSegment, outSegment, aSum, rSum, gSum, bSum;
