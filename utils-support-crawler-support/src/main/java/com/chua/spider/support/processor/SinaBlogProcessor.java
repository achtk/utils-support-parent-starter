 ...
 * @author CH
 */
public class SinaBlogProcessor implements PageProcessor, com.chua.common.support.lang.spide.processor.PageProcessor {
    ...
    public void process(Page page) {
        this.process(new MagicOrginPage(page));
    }
