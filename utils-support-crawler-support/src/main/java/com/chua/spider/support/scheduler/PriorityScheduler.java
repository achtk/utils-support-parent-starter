 ...
 * @author CH
 */
public class PriorityScheduler extends us.codecraft.webmagic.scheduler.PriorityScheduler implements Scheduler<Spider> {
    @Override
    public void push(Request request, Task<us.codecraft.webmagic.Spider> task) {
