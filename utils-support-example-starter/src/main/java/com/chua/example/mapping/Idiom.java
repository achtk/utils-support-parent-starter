...
public interface Idiom {
     ...
     * @return 成语
     */
    @MappingRequest(value = "GET /1196-1?keyword=${name}&page=${page}&rows=${row}&showapi_appid=1191705&showapi_sign=882fe29fdbee429d9ac55e8d234ffa40", jsonPath = "$.showapi_res_body.data")
