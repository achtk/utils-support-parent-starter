...
public class ViewFactoryExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        viewServer.addPlugin("logo", new ImageWaterImageFilter(new URL("").openStream()));
        viewServer.addPlugin("logo-text", new TextImgWaterImageFilter("我是水印", new URL("").openStream(), new com.chua.common.support.protocol.image.ImagePoint(40, 20)));
        ...
        viewServer.addContext("achtk", ViewConfig.newBuilder().setType("alibaba").setAppKey("").setAppSecret(""));
