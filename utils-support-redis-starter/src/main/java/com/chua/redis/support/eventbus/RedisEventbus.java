package com.chua.redis.support.eventbus;//package com.chua.redis.support.eventbus;
//
...
//            try {
//                shardedJedis.rpush(name.getBytes(UTF_8), serializer.serializer(Json.toJson(new EventbusMessage(message))));
