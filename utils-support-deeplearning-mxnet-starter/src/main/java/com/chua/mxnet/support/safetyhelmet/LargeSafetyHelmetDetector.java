 ...
 * @author CH
 */
public class LargeSafetyHelmetDetector extends AbstractPytorchDetector<DetectedObjects> {
    public LargeSafetyHelmetDetector(DetectionConfiguration configuration) {
        super(configuration,
