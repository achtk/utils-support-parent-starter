 ...
 * @author CH
 */
public class ImapClient extends AbstractClient<Session> {
    private Session session;

    protected ImapClient(ClientOption clientOption) {
        super(clientOption);
    }
    ...
    public void connectClient() {
        ...
        props.setProperty("mail.imap.host", netAddress.getHost()); // 按需要更改
        props.setProperty("mail.imap.port", String.valueOf(netAddress.getPort(110)));
        // SSL安全连接参数
        props.setProperty("mail.imap.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
        props.setProperty("mail.imap.socketFactory.fallback", "false");
        props.setProperty("mail.imap.socketFactory.port", String.valueOf(describe().getString("mail.imap.socketFactory.port", "993")));
