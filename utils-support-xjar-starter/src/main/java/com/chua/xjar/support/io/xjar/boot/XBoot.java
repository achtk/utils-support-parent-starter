...
import com.chua.xjar.support.io.xjar.*;
...
public class XBoot extends XFilters implements XConstants {
     ...
     * @param xKey          密钥
     * @param filter        过滤器
     * @param dependsFilter 依赖过滤器
     * @throws Exception 加密异常
     */
    public static void encrypt(String src, String dest, XKey xKey, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) throws Exception {
        encrypt(new File(src), new File(dest), xKey, filter, dependsFilter);
    }
     ...
     * @throws Exception 加密异常
     */
    public static void encrypt(File src, File dest, XKey xKey, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) throws Exception {
        XBootEncryptor xBootEncryptor = new XBootEncryptor(new XJdkEncryptor(), filter, dependsFilter);
        xBootEncryptor.encrypt(xKey, src, dest);
    }
     ...
     * @throws Exception 加密异常
     */
    public static void encrypt(InputStream in, OutputStream out, XKey xKey, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) throws Exception {
        XBootEncryptor xBootEncryptor = new XBootEncryptor(new XJdkEncryptor(), filter, dependsFilter);
        xBootEncryptor.encrypt(xKey, in, out);
    }
     ...
     * @throws Exception 加密异常
     */
    public static void encrypt(String src, String dest, String password, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) throws Exception {
        encrypt(src, dest, XKit.key(password), filter, dependsFilter);
    }
     ...
     * @throws Exception 加密异常
     */
    public static void encrypt(File src, File dest, String password, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) throws Exception {
        encrypt(src, dest, XKit.key(password), filter, dependsFilter);
    }
     ...
     * @throws Exception 加密异常
     */
    public static void encrypt(InputStream in, OutputStream out, String password, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) throws Exception {
        encrypt(in, out, XKit.key(password), filter, dependsFilter);
    }
