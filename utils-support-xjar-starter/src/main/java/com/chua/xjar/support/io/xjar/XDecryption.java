...
public class XDecryption {
    ...
    public XDecryption include(Pattern regex) {
        includes.mix(XFilters.regex(regex.pattern()));
        return this;
    }
    ...
    public XDecryption exclude(String ant) {
        excludes.mix(XFilters.not(XFilters.ant(ant)));
        return this;
    }
    ...
    public XDecryption exclude(Pattern regex) {
        excludes.mix(XFilters.not(XFilters.regex(regex.pattern())));
        return this;
    }
