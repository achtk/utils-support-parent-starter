...
public class XJarEncryptor extends XEntryEncryptor<JarArchiveEntry> implements XEncryptor, XConstants {
    ...
    public XJarEncryptor(XEncryptor xEncryptor, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) {
    ...
    public XJarEncryptor(XEncryptor xEncryptor, int level, XEntryFilter<JarArchiveEntry> filter, XEntryFilter<JarArchiveEntry> dependsFilter) {
