...
public class HttpChannelFutureListener implements ChannelFutureListener {
	...
	public HttpChannelFutureListener(WebServerRequest msg, ChannelHandlerContext ctx) {
		this.msg = msg;
		this.ctx = ctx;
	}
	...
	public void operationComplete(ChannelFuture future) throws Exception {
		...
		if (future.isSuccess()) {
			...
			//将客户端请求报文发送给服务端
			future.channel().writeAndFlush(msg.getRequest());
			return;
		}
