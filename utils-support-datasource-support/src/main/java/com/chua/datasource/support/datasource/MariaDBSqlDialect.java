...
public class MariaDBSqlDialect extends SqlDialect {
    ...
    public static final SqlDialect DEFAULT = new MariaDBSqlDialect(DEFAULT_CONTEXT);
     ...
     */
    public MariaDBSqlDialect(Context context) {
        super(context);
        majorVersion = context.databaseMajorVersion();
    }

    public MariaDBSqlDialect(DatabaseProduct databaseProduct, String databaseProductName, String identifierQuoteString) {
