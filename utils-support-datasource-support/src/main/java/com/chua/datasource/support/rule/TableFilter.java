 ...
 */
public class TableFilter extends Filter implements TableRel {
    public TableFilter(
    ...
    @Override
    public TableFilter copy(RelTraitSet traitSet, RelNode input,
                            RexNode condition) {
        return new TableFilter(getCluster(), traitSet, input, condition);
    }
    ...
    public void implement(Implementor implementor) {
        ...
        Translator translator =
                new Translator(implementor.rexBuilder,
                        TableRules.fieldNames(getRowType()));
    ...
    static class Translator {
        ...
        private boolean translateBinary2(String op, RexNode left, RexNode right) {
            ...
            switch (left.getKind()) {
                ...
                case ITEM:
                    String itemName = TableRules.isItem((RexCall) left);
                    if (itemName != null) {
