 ...
 */
public class RuleSort extends Sort implements TableRel {
    public RuleSort(RelOptCluster cluster, RelTraitSet traitSet,
    ...
    public Sort copy(RelTraitSet traitSet, RelNode input,
        ...
        return new RuleSort(getCluster(), traitSet, input, collation, offset,
                fetch);
    }
