 ...
 * @author CH
 */
public class MediumSafetyHelmetDetector extends AbstractPytorchDetector<DetectedObjects> {
    public MediumSafetyHelmetDetector(DetectionConfiguration configuration) {
        super(configuration,
                new SafetyHelmetTranslator(configuration),
                "MXNet",
                null,
                StringUtils.defaultString(configuration.modelPath(), "mobilenet1.0"),
                "https://aias-home.oss-cn-beijing.aliyuncs.com/models/mobilenet1.0.zip",
                true);
    }
