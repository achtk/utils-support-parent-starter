package com.chua.pytorch.support.onnx;
 ...
 * @author CH
 */
public class OnnxDetector extends AbstractPytorchDetector<DetectedObjects> {
    ...
    public OnnxDetector(DetectionConfiguration configuration) {
        super(configuration,
