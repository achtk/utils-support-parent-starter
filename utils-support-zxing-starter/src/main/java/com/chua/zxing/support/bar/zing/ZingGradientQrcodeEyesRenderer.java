 ...
 * @author CH
 */
public class ZingGradientQrcodeEyesRenderer implements ZingRenderer {
    ...
    public ZingGradientQrcodeEyesRenderer(BitMatrix bitMatrix) {
    ...
    public void render(BufferedImage image, BarCodeBuilder.QrCodeEyesFormat format, ZingQrcodeEyesPosition position, Color slave, Color border, Color point) {
        ...
        for (int y = 0; y < bitMatrix.getHeight(); y++) {
            for (int x = 0; x < bitMatrix.getWidth(); x++) {
                ...
                boolean b = (x > halfW - IMAGE_HALF_WIDTH - FRAME_WIDTH
