...
public class ArInnerCompressInputStream extends AbstractApacheInnerCompressInputStream {
    ...
    ArchiveInputStream createArchiveInputStream() throws IOException {
        ...
        return new ArArchiveInputStream(innerCompressInputStream.getInputStream());
    }
}