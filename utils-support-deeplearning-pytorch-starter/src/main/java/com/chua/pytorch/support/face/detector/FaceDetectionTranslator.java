...
public class FaceDetectionTranslator implements Translator<Image, DetectedObjects> {
    ...
    public FaceDetectionTranslator() {
        this(0.85f, 0.45f, new double[]{0.1f, 0.2f}, 5000, new int[][]{{16, 32}, {64, 128}, {256, 512}}, new int[]{8, 16, 32});
    }
    ...
    public NDList processInput(TranslatorContext ctx, Image input) {
        ...
        NDArray mean =
                ctx.getNDManager().create(new float[]{104f, 117f, 123f}, new Shape(3, 1, 1)).getNDArrayInternal().getArray();
    ...
    public DetectedObjects processOutput(TranslatorContext ctx, NDList list) {
        ...
        landms = decicandela(landms, boxRecover, scaleXY);
    ...
    private NDArray decicandela(NDArray pre, NDArray priors, double scaleXY) {
        NDArray point1 =
