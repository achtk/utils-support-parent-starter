...
@Slf4j
@AllArgsConstructor
public class MemSearchOperatorTemplate implements SearchOperatorTemplate {
    ...
    public HitData quickSearch(String keyword, String sort, String columns, int offset, int pageSize) {
        ...
        ExecutorService executorService = ThreadUtils.newFixedThreadExecutor(thread, "lucene-task");
        final int newPageSize = (pageSize < 0 || pageSize > 1000 ? 1000 : pageSize);
        //当前页
        int endPage = offset * newPageSize;
        //当前页
