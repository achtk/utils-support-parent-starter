package com.chua.common.support.resource.repository.resolver;//package com.chua.common.support.repository.resolver;
//
//import com.chua.common.support.context.annotation.AutoInject;
//import com.chua.common.support.matcher.PathMatcher;
//import com.chua.common.support.projects.Projects;
//import com.chua.common.support.repository.FileSystemMetadata;
...
//    LinuxResourceMatcher matcher = new LinuxResourceMatcher();
//
//    @Override
...
//
//        if (Projects.isLinux()) {
//            List<Resource> resources = matcher.findResources(new File(root.getFile()).getAbsolutePath() + "/" + name, false);
//            for (Resource resource : resources) {
//                if (resource instanceof FileSystemResource) {
//                    result.add(new FileSystemMetadata(((FileSystemResource) resource).getFile()));
//                } else {
//                    result.add(new UrlMetadata(resource.getUrl()));
//                }
//            }
//            return result;
//        }
