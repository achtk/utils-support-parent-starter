 ...
 * @since 2022-01-14
 */
public class AbstractByteSourceInputStream extends AbstractByteSource {
    ...
    public AbstractByteSourceInputStream(final InputStream is) {
        this(is, "");
    }

    public AbstractByteSourceInputStream(final InputStream is, final String filename) {
        super(filename);
