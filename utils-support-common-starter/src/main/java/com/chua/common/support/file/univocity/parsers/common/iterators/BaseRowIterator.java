...
/**
 * An iterator of {@code String[]}. Created when {@link BaseParser#iterate(File)}
 * (and its overloaded counterparts) is called
 *
 * @author Univocity Software Pty Ltd - <a href="mailto:dev@univocity.com">dev@univocity.com</a>
 */
public abstract class BaseRowIterator extends BaseParserIterator<String[]> {

	public BaseRowIterator(BaseParser parser) {
		super(parser);
	}
