...
/**
 * This class provides default instances of common implementations if {@code com.chua.common.support.file.univocity.parsers.conversions.Conversion}, as well as useful methods for obtaining new instances of these.
 *
...
public class Conversions {
	...
	private static final UpperCaseConversion UPPER_CASE = new UpperCaseConversion();
	private static final LowerCaseConversion LOWER_CASE = new LowerCaseConversion();
	private static final TrimConversion TRIM = new TrimConversion();
	private static final ToStringConversion TO_STRING = new ToStringConversion();
