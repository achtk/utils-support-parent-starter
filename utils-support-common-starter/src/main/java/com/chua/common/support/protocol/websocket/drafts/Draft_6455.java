package com.chua.common.support.protocol.websocket.drafts;
...
import com.chua.common.support.protocol.websocket.extensions.DefaultExtension;
...
import com.chua.common.support.protocol.websocket.protocols.Protocol;
  ...
  public List<Framedata> createFrames(ByteBuffer binary, boolean mask) {
    ...
    try {
      curframe.isValid();
        ...
        throw new NotSpendableException(e);
    }
