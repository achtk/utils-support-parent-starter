 ...
 */
package com.chua.common.support.json.jsonpath.internal.function.latebinding;
...
public class PathLateBindingValue implements ILateBindingValue {
    ...
    public PathLateBindingValue(final Path path, final Object rootDocument, final JsonConfiguration configuration) {
        this.path = path;
