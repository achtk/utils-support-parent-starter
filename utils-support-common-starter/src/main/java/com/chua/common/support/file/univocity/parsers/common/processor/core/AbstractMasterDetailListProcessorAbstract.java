 ...
 * @see BaseParser
 */
public abstract class AbstractMasterDetailListProcessorAbstract<T extends AbstractContext> extends AbstractMasterDetailProcessorAbstract<T> {
	 ...
	 */
	public AbstractMasterDetailListProcessorAbstract(RowPlacement rowPlacement, AbstractObjectListProcessorAbstract detailProcessor) {
	 ...
	 * @param detailProcessor the {@link ObjectRowListProcessor} that processes detail rows.
	 */
	public AbstractMasterDetailListProcessorAbstract(AbstractObjectListProcessorAbstract detailProcessor) {
