...
public interface NameHelper {
    ...
    List<String> STRING_LIST = Arrays.asList("boolean", "char", "byte", "short", "int", "long", "float", "double", "void");
        ...
        if (STRING_LIST.contains(typeName)) {
            ...
            if (typeName.contains("[")) {
                ...
                if (STRING_LIST.contains(type)) {
                    type = PRIMITIVE_DESCRIPTORS.get(STRING_LIST.indexOf(type));
                } else {
                    type = "L" + type + ";";
                }
                type = array + type;
