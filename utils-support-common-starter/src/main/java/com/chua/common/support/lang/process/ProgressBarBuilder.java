...
public class ProgressBarBuilder {
    ...
    private String task = "Downloading:";
    ...
    private ProgressBarStyle style = ProgressBarStyle.COLORFUL_UNICODE_BLOCK_SIMPLE;
    ...
    public ProgressBarBuilder openAnsi() {
        this.ansi = true;
        return this;
    }

    public ProgressBarBuilder setProgressStyle(ProgressStyle progressStyle) {
    ...
    public ProgressBar build() {
        return new ProgressBar(
                ...
                new DefaultProgressBarRenderer(
                        ...
                        !hideEta, eta),
                consumer == null ? Util.createConsoleConsumer(maxRenderedLength) : consumer, progressStyle, ansi
        );
    }
}
