package com.chua.common.support.jsoup.safety;

/*
    Thank you to Ryan Grove (wonko.com) for the Ruby HTML cleaner http:    this safe-list configuration, and the initial defaults.
 */
...
/**
 ...
 the <a href="https: XSS attack examples (that jsoup will safegaurd against the default Cleaner and Safelist configuration).
 </p>
...
public class Safelist {
     ...
     * <p>
     * Note that the output of {@link com.chua.common.support.jsoup.Jsoup#clean(String, Safelist)} is still <b>HTML</b> even when using
    ...
    public Safelist addEnforcedAttribute(String tag, String attribute, String value) {
        ...
        if (enforcedAttributes.containsKey(tagName)) {
            ...
            Map<AttributeKey, AttributeValue> attrMap = new LinkedHashMap<>();
