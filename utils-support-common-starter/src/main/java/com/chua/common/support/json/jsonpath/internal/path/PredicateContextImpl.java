...
import com.chua.common.support.json.jsonpath.spi.mapper.MappingException;
...
public class PredicateContextImpl implements Predicate.PredicateContext {
    ...
    public PredicateContextImpl(Object contextDocument, Object rootDocument, JsonConfiguration configuration, HashMap<Path, Object> documentPathCache) {
