 ...
 * 		</ul>
 *   	<i>{@link BaseFormat#lineSeparator} defaults to the system line separator</i>
 *  </li>
 ...
 *  	<ul>
 * 			<li>When <i>reading</i> a text-based input, the sequence of characters defined in {@link BaseFormat#lineSeparator} will be replaced by this character.</li>
 * 			<li>When <i>writing</i> to a text-based output, this character will be replaced by the sequence of characters defined in {@link BaseFormat#lineSeparator}.</li>
 * 		</ul>
 *  	<p><i>{@link BaseFormat#normalizedNewline} defaults to '\n'.</i>
 *  </li>
 ...
 *  	<p><i>{@link BaseFormat#comment} defaults to '#'.</i></li>
 * </ul>
 *
...
public abstract class BaseFormat implements Cloneable {

	private static final String SYSTEM_LINE_SEPARATOR_STRING;
	private static final char[] SYSTEM_LINE_SEPARATOR;

	static {
		String lineSeparator = System.getProperty("line.separator");
		if (lineSeparator == null) {
			SYSTEM_LINE_SEPARATOR_STRING = "\n";
		} else {
			SYSTEM_LINE_SEPARATOR_STRING = lineSeparator;
		}
		SYSTEM_LINE_SEPARATOR = SYSTEM_LINE_SEPARATOR_STRING.toCharArray();
	}
	...
	protected BaseFormat() {
		this.lineSeparator = SYSTEM_LINE_SEPARATOR.clone();
		this.lineSeparatorString = SYSTEM_LINE_SEPARATOR_STRING;
	}
	...
	public static char[] getSystemLineSeparator() {
		return SYSTEM_LINE_SEPARATOR.clone();
	}
	...
	/**
	 * Returns the normalized newline character, which is automatically replaced by {@link BaseFormat#lineSeparator} when reading/writing. Defaults to '\n'.
	 *
	...
	/**
	 * Sets the normalized newline character, which is automatically replaced by {@link BaseFormat#lineSeparator} when reading/writing
	 *
	...
	/**
	 * Compares the given character against the {@link BaseFormat#normalizedNewline} character.
	 *
	...
	@Override
	protected BaseFormat clone() {
		try {
			return (BaseFormat) super.clone();
