...
import com.chua.common.support.json.jsonpath.internal.DefaultsImpl;
...
public class JsonConfiguration {
    ...
    private JsonConfiguration(JsonProvider jsonProvider, MappingProvider mappingProvider, EnumSet<Option> options, Collection<EvaluationListener> evaluationListeners) {
     ...
     */
    public JsonConfiguration addEvaluationListeners(EvaluationListener... evaluationListener) {
        return JsonConfiguration.builder().jsonProvider(jsonProvider).mappingProvider(mappingProvider).options(options).evaluationListener(evaluationListener).build();
    }
     ...
     * @return a new configuration
     */
    public JsonConfiguration setEvaluationListeners(EvaluationListener... evaluationListener) {
        return JsonConfiguration.builder().jsonProvider(jsonProvider).mappingProvider(mappingProvider).options(options).evaluationListener(evaluationListener).build();
    }
     ...
     * @return a new configuration
     */
    public JsonConfiguration jsonProvider(JsonProvider newJsonProvider) {
        return JsonConfiguration.builder().jsonProvider(newJsonProvider).mappingProvider(mappingProvider).options(options).evaluationListener(evaluationListeners).build();
    }
     ...
     * @return a new configuration
     */
    public JsonConfiguration mappingProvider(MappingProvider newMappingProvider) {
        return JsonConfiguration.builder().jsonProvider(jsonProvider).mappingProvider(newMappingProvider).options(options).evaluationListener(evaluationListeners).build();
    }
     ...
     * @return a new configuration
     */
    public JsonConfiguration addOptions(Option... options) {
        EnumSet<Option> opts = EnumSet.noneOf(Option.class);
        opts.addAll(this.options);
        opts.addAll(asList(options));
        return JsonConfiguration.builder().jsonProvider(jsonProvider).mappingProvider(mappingProvider).options(opts).evaluationListener(evaluationListeners).build();
    }
     ...
     */
    public JsonConfiguration setOptions(Option... options) {
        return JsonConfiguration.builder().jsonProvider(jsonProvider).mappingProvider(mappingProvider).options(options).evaluationListener(evaluationListeners).build();
    }
     ...
     */
    public static JsonConfiguration defaultConfiguration() {
        Defaults defaults = getEffectiveDefaults();
        return JsonConfiguration.builder().jsonProvider(defaults.jsonProvider()).options(defaults.options()).build();
    }
    ...
    public static class ConfigurationBuilder {
        ...
        public JsonConfiguration build() {
            ...
            return new JsonConfiguration(jsonProvider, mappingProvider, options, evaluationListener);
        }
    }
