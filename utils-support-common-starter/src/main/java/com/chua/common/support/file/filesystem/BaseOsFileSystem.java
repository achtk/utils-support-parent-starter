...
public abstract class BaseOsFileSystem {
    ...
    public BaseOsFileSystem(ResourceFile resourceFile) {
    ...
    public BaseOsFileSystem(InputStream inputStream) {
     ...
     * @param bytes 文件
     */
    public static BaseOsFileSystem open(byte[] bytes) throws IOException {
     ...
     */
    public static BaseOsFileSystem open(InputStream inputStream) throws IOException {
     ...
     * @param file 文件
     */
    public static BaseOsFileSystem open(String file) {
     ...
     * @param inputStream 文件
     */
    private static BaseOsFileSystem of(String contentType, InputStream inputStream) {
        return ServiceProvider.of(BaseOsFileSystem.class).getNewExtension(contentType, "temp", inputStream);
    }
     ...
     * @param file 文件
     */
    private static BaseOsFileSystem of(ResourceFile file) {
        ...
        return ServiceProvider.of(BaseOsFileSystem.class).getNewExtension(contentType, "temp", file);
    }
