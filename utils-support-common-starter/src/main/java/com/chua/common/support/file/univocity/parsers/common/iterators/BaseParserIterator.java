 ...
 */
abstract class BaseParserIterator<T> implements IterableResult<T, ParsingContext> {

	protected final BaseParser parser;
	 ...
	 */
	protected BaseParserIterator(BaseParser parser) {
		this.parser = parser;
	}
