...
public final class UrlBuilder implements Serializable {
    ...
    public static UrlBuilder of(String url, Charset charset) {
        return of(Objects.requireNonNull(UrlUtils.toUrl(StringUtils.trim(url))), charset);
    }
    ...
    public String getSchemeWithDefault() {
        return StringUtils.defaultString(this.scheme, DEFAULT_SCHEME);
    }
    ...
    public String getPathStr() {
        return null == this.path ? SYMBOL_LEFT_SLASH : this.path.build(charset);
    }
    ...
    public URL toURL(URLStreamHandler handler) {
        ...
        // path
        fileBuilder.append(StringUtils.defaultString(getPathStr(), SYMBOL_LEFT_SLASH));
