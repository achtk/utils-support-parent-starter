...
import com.chua.common.support.json.jsonpath.internal.function.latebinding.ILateBindingValue;
...
public class Parameter {
     ...
     *
     * @param type       The type to translate the collection into.
     * @param ctx        Context.
     * @param parameters Collection of parameters.
     * @param <T>        Type T returned as a List of T.
     * @return List of T either empty or containing contents.
     */
     ...
     *
     * @param expectedType the expected class type to consume, if null or not of this type the element is not added to the array.
     * @param ctx          the JSON context to determine if this is an array or value.
     * @param collection   The collection to append into.
