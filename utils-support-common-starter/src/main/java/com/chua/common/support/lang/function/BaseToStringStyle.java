...
import com.chua.common.support.utils.StringEscapeUtils;
...
public abstract class BaseToStringStyle implements Serializable {
     ...
     * </pre>
     */
    public static final BaseToStringStyle DEFAULT_STYLE = new DefaultToStringStyle();
     ...
     * </pre>
     */
    public static final BaseToStringStyle MULTI_LINE_STYLE = new MultiLineToStringStyle();
     ...
     * </pre>
     */
    public static final BaseToStringStyle NO_FIELD_NAMES_STYLE = new NoFieldNameToStringStyle();
     ...
     * @since 2.1
     */
    public static final BaseToStringStyle SHORT_PREFIX_STYLE = new ShortPrefixToStringStyle();
     ...
     * </pre>
     */
    public static final BaseToStringStyle SIMPLE_STYLE = new SimpleToStringStyle();
     ...
     * @since 3.4
     */
    public static final BaseToStringStyle NO_CLASS_NAME_STYLE = new NoClassNameToStringStyle();
     ...
     * @since 3.4
     */
    public static final BaseToStringStyle JSON_STYLE = new JsonToStringStyle();
     ...
     */
    private static final class DefaultToStringStyle extends BaseToStringStyle {
     ...
     */
    private static final class NoFieldNameToStringStyle extends BaseToStringStyle {
     ...
     * {@code StandardToStringStyle} to ensure its immutability.</p>
     */
    private static final class ShortPrefixToStringStyle extends BaseToStringStyle {
     ...
     * {@code StandardToStringStyle} to ensure its immutability.</p>
     */
    private static final class SimpleToStringStyle extends BaseToStringStyle {
     ...
     * {@code StandardToStringStyle} to ensure its immutability.</p>
     */
    private static final class MultiLineToStringStyle extends BaseToStringStyle {
     ...
     * {@code StandardToStringStyle} to ensure its immutability.</p>
     */
    private static final class NoClassNameToStringStyle extends BaseToStringStyle {
     ...
     * @since 3.4
     */
    private static final class JsonToStringStyle extends BaseToStringStyle {
