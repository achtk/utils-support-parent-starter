...
import com.chua.common.support.mysql.event.TableMapEventMetadata;
import com.chua.common.support.mysql.event.TableMapEventMetadata.DefaultCharset;
...
public class TableMapEventMetadataDeserializer {
    ...
    private enum MetadataFieldType {
        ...
        COLUMN_NAME(4),
        /**
         * The string values of SET columns
         */
        SET_STR_VALUE(5),
        /**
         * The string values is ENUM columns
         */
        ENUM_STR_VALUE(6),
        /**
         * The real type of geometry columns
         */
        GEOMETRY_TYPE(7),
        /**
         * The primary key without any prefix
         */
        SIMPLE_PRIMARY_KEY(8),
        /**
         * The primary key with some prefix
         */
        PRIMARY_KEY_WITH_PREFIX(9),
        /**
         * Charsets of ENUM and SET columns
         */
