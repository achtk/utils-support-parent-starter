...
import com.chua.common.support.json.jsonpath.spi.cache.Cache;
import com.chua.common.support.json.jsonpath.spi.cache.CacheProvider;
...
public class JsonContext implements DocumentContext {
    ...
    JsonContext(Object json, JsonConfiguration configuration) {
    ...
    private <T> T convert(Object obj, Class<T> targetType, JsonConfiguration configuration) {
