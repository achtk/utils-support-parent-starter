...
/**
 * An internal registry of annotated elements and their properties that have been set via a {@link com.chua.common.support.file.univocity.parsers.annotations.Copy} annotation.
 * @author Administrator
 */
public class AnnotationRegistry {

	private static final Map<AnnotatedElement, FieldAnnotations> MODIFIED_ANNOTATIONS = new HashMap<AnnotatedElement, FieldAnnotations>();

	/**
	 * Associates a value to a given annotation attribute
	 *
	 * @param annotatedElement a method or field that has an annotation whose properties are changed by a {@link com.chua.common.support.file.univocity.parsers.annotations.Copy} annotation
	...
	static synchronized final void setValue(AnnotatedElement annotatedElement, Annotation annotation, String attribute, Object newValue) {
		FieldAnnotations attributes = MODIFIED_ANNOTATIONS.get(annotatedElement);
		if (attributes == null) {
			attributes = new FieldAnnotations();
			MODIFIED_ANNOTATIONS.put(annotatedElement, attributes);
		}
		attributes.setValue(annotation, attribute, newValue);
	}

	/**
	 * Returns the a value to a given annotation attribute that might have been modified by a {@link com.chua.common.support.file.univocity.parsers.annotations.Copy} annotation
	 *
	 * @param annotatedElement a method or field that has an annotation whose properties might have been changed by a {@link com.chua.common.support.file.univocity.parsers.annotations.Copy} annotation
	 ...
	 * @param valueIfNull      the value to return from the unmodified annotation, if it has not been changed by a {@link com.chua.common.support.file.univocity.parsers.annotations.Copy}
	 ...
	 * @param annotation       the possibly altered annotation of the given annotatedElement
	 * @param attribute        the attribute of the possibly altered annotation
	 * @return the value associated with the given annotation property, or {@code null} if it has not been modified by a {@link com.chua.common.support.file.univocity.parsers.annotations.Copy}
	 */
