...
public class Element extends Node {
    ...
    /**
     * Get the name of the tag for this element. E.g. {@code div}. If you are using {@link ParseSettings#PRESERVE_CASE
    ...
    public String cssSelector() {
        ...
        String classes = join(classNames(), ".");
        if (classes.length() > 0) {
    ...
    private static void appendNormalisedText(StringBuilder accum, TextNode textNode) {
        ...
        if (preserveWhitespace(textNode.parentNode) || textNode instanceof CharDataNode) {
            accum.append(text);
            return;
        }
    ...
    public String data() {
        ...
        for (Node childNode : childNodes) {
            if (childNode instanceof DataNode) {
            ...
            } else if (childNode instanceof CharDataNode) {
                ...
                CharDataNode charDataNode = (CharDataNode) childNode;
                sb.append(charDataNode.getWholeText());
            }
        }
        return sb.toString();
    }
    ...
    public Element classNames(Set<String> classNames) {
        ...
        if (classNames.isEmpty()) {
            ...
            attributes().put("class", join(classNames, " "));
        }
        return this;
    }
     ...
     * otherwise.
     * @see com.chua.common.support.jsoup.parser.Parser#setTrackPosition(boolean)
