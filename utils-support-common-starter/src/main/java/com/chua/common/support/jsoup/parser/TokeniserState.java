...
import com.chua.common.support.jsoup.nodes.DocumentType;
...
enum TokeniserState {
    ...
    CdataSection {
        void read(Tokeniser t, CharacterReader r) {
            ...
            if (r.matchConsume("]]>") || r.isEmpty()) {
                t.emit(new BaseToken.CharData(t.dataBuffer.toString()));
                t.transition(Data);
    ...
    private static final char replacementChar = Tokeniser.REPLACEMENT_CHAR;
    private static final String replacementStr = String.valueOf(Tokeniser.REPLACEMENT_CHAR);
