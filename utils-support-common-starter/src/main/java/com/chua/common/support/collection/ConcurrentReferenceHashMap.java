...
public class ConcurrentReferenceHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    protected interface Reference<K, V> {
         ...
         * @return Return the referenced entry, or {@code null} if the entry is no longer available.
         */
         ...
         * @return Return the hash for the reference.
         */
        int getHash();

        /**
         * Return the next reference in the chain, or {@code null} if none.
         * @return  Return the next reference in the chain, or {@code null} if none.
         */
