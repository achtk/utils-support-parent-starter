...
import com.chua.common.support.reflection.reflections.util.FilterBuilder;
...
import static com.chua.common.support.reflection.reflections.util.JavassistHelper.*;

/**
 * base Reflections {@link java.util.Scanner}s such as:
 * <ul>
 *   <li>{@link #SubTypes}</li>
