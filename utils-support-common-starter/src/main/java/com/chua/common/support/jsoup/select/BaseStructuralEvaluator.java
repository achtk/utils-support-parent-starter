 ...
 */
abstract class BaseStructuralEvaluator extends AbstractEvaluator {
    ...
    static class Has extends BaseStructuralEvaluator {
    ...
    static class Not extends BaseStructuralEvaluator {
    ...
    static class Parent extends BaseStructuralEvaluator {
    ...
    static class ImmediateParent extends BaseStructuralEvaluator {
    ...
    static class PreviousSibling extends BaseStructuralEvaluator {
    ...
    static class ImmediatePreviousSibling extends BaseStructuralEvaluator {
