...
import com.chua.common.support.mysql.event.PrepareEventData;
 ...
 */
public class PrepareEventDataDeserializer implements EventDataDeserializer<PrepareEventData> {
    @Override
    public PrepareEventData deserialize(ByteArrayInputStream inputStream) throws IOException {
        PrepareEventData xaPrepareEventData = new PrepareEventData();
