...
/**
 * An iterator of {@link Record}s. Created when {@link BaseParser#iterateRecords(File)}
 * (and its overloaded counterparts) is called
 *
 * @author Univocity Software Pty Ltd - <a href="mailto:dev@univocity.com">dev@univocity.com</a>
 */
public abstract class BaseRecordIterator extends BaseParserIterator<Record> {

	public BaseRecordIterator(BaseParser parser) {
		super(parser);
	}
