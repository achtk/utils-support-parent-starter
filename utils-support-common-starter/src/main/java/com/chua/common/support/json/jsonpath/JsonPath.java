...
import com.chua.common.support.json.jsonpath.internal.*;
...
import static com.chua.common.support.json.jsonpath.Option.ALWAYS_RETURN_LIST;
import static com.chua.common.support.json.jsonpath.Option.AS_PATH_LIST;
import static com.chua.common.support.json.jsonpath.internal.Utils.*;
...
public class JsonPath {
    ...
    public <T> T read(Object jsonObject) {
        return read(jsonObject, JsonConfiguration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T read(Object jsonObject, JsonConfiguration configuration) {
     ...
     */
    public <T> T set(Object jsonObject, Object newVal, JsonConfiguration configuration) {
     ...
     * @return the updated jsonObject or the path list to updated objects if option AS_PATH_LIST is set.
     */
    public <T> T map(Object jsonObject, MapFunction mapFunction, JsonConfiguration configuration) {
        notNull(jsonObject, "json can not be null");
        notNull(configuration, "configuration can not be null");
     ...
     */
    public <T> T delete(Object jsonObject, JsonConfiguration configuration) {
        notNull(jsonObject, "json can not be null");
        notNull(configuration, "configuration can not be null");
        EvaluationContext evaluationContext = path.evaluate(jsonObject, jsonObject, configuration, true);
        if (evaluationContext.getPathList().isEmpty()) {
     ...
     */
    public <T> T add(Object jsonObject, Object value, JsonConfiguration configuration) {
        notNull(jsonObject, "json can not be null");
        notNull(configuration, "configuration can not be null");
        EvaluationContext evaluationContext = path.evaluate(jsonObject, jsonObject, configuration, true);
        if (evaluationContext.getPathList().isEmpty()) {
     ...
     * @return the updated jsonObject or the path list to updated objects if option AS_PATH_LIST is set.
     */
    public <T> T put(Object jsonObject, String key, Object value, JsonConfiguration configuration) {
        notNull(jsonObject, "json can not be null");
    ...
    public <T> T renameKey(Object jsonObject, String oldKeyName, String newKeyName, JsonConfiguration configuration) {
        notNull(jsonObject, "json can not be null");
    ...
    public <T> T read(String json) {
        return read(json, JsonConfiguration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(String json, JsonConfiguration configuration) {
    ...
    public <T> T read(File jsonFile) throws IOException {
        return read(jsonFile, JsonConfiguration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(File jsonFile, JsonConfiguration configuration) throws IOException {
    ...
    public <T> T read(InputStream jsonInputStream) throws IOException {
        return read(jsonInputStream, JsonConfiguration.defaultConfiguration());
    }
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(InputStream jsonInputStream, JsonConfiguration configuration) throws IOException {
     ...
     */
    @SuppressWarnings({"unchecked"})
    public <T> T read(InputStream jsonInputStream, String charset, JsonConfiguration configuration) throws IOException {
        notNull(jsonInputStream, "json input stream can not be null");
     ...
     */
    public static ParseContext using(JsonConfiguration configuration) {
    ...
    public static ParseContext using(JsonProvider provider) {
        return new ParseContextImpl(JsonConfiguration.builder().jsonProvider(provider).build());
    }

    /**
     * Parses the given JSON input using the default {@link JsonConfiguration} and
    ...
    /**
     * Parses the given JSON input using the provided {@link JsonConfiguration} and
     * returns a {@link DocumentContext} for path evaluation
     *
     * @param json input
     * @return a read context
     */
    public static DocumentContext parse(Object json, JsonConfiguration configuration) {
     ...
     * @return a read context
     */
    public static DocumentContext parse(String json, JsonConfiguration configuration) {
        return new ParseContextImpl(configuration).parse(json);
    }
     ...
     * @return a read context
     */
    public static DocumentContext parse(InputStream json, JsonConfiguration configuration) {
        return new ParseContextImpl(configuration).parse(json);
    }
     ...
     * @return a read context
     */
    public static DocumentContext parse(File json, JsonConfiguration configuration) throws IOException {
        return new ParseContextImpl(configuration).parse(json);
    }
     ...
     * @return a read context
     */
    public static DocumentContext parse(URL json, JsonConfiguration configuration) throws IOException {
        return new ParseContextImpl(configuration).parse(json);
    }

    private <T> T resultByConfiguration(Object jsonObject, JsonConfiguration configuration, EvaluationContext evaluationContext) {
    ...
    private <T> T handleMissingPathInContext(final JsonConfiguration configuration) {
        boolean optAsPathList = configuration.containsOption(AS_PATH_LIST);
        boolean optAlwaysReturnList = configuration.containsOption(Option.ALWAYS_RETURN_LIST);
        if (optAsPathList) {
            return (T) configuration.jsonProvider().createArray();
