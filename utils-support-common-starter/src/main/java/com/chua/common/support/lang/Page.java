...
public class Page implements Segment<Integer>, Serializable {
    ...
    public void addOrder(Order... orders) {
        this.orders = ArrayUtils.addElement(this.orders, orders);
    }
    ...
    public Integer getStartIndex() {
        return PageUtils.getStart(this.pageNumber, this.pageSize);
    }
    ...
    public Integer getEndIndex() {
        return PageUtils.getEnd(this.pageNumber, this.pageSize);
    }
    ...
    public int[] getStartEnd() {
        return PageUtils.transToStartEnd(pageNumber, pageSize);
    }
