...
import com.chua.common.support.jsoup.xpath.model.JXDocument;
...
public class PageParserProcessor implements ParserProcessor {
    ...
    public static void parseFieldAnnotations(Object pageVo, Element pageVoElement, Field field) {
        ...
        JXDocument jxDocument = new JXDocument(Jsoup.parse(elements.html()));
     ...
     * @return String 数据
     */
    public static String parseElement(Object fieldElement) {
