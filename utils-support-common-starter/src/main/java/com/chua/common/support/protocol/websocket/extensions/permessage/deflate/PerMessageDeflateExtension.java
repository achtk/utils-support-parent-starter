package com.chua.common.support.protocol.websocket.extensions.permessage.deflate;
...
public class PerMessageDeflateExtension extends BaseCompressionExtension {
  ...
  public void isFrameValid(Framedata inputFrame) throws InvalidDataException {
      boolean b = (inputFrame instanceof ContinuousFrame) && (inputFrame.isRsv1() || inputFrame.isRsv2()
              || inputFrame.isRsv3());
      if (b) {
