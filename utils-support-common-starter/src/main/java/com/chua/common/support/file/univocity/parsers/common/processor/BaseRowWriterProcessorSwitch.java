 ...
 */
public abstract class BaseRowWriterProcessorSwitch implements RowWriterProcessor<Object> {
	 ...
	 * If {@code null}, the indexes of fields that have been selected using {@link BaseCommonSettings#selectFields(String...)}
	 * or {@link BaseCommonSettings#selectIndexes(Integer...)} will be returned.
	 *
