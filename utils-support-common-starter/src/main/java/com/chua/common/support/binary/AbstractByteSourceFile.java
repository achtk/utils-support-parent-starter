 ...
 * @since 2022-01-14
 */
public class AbstractByteSourceFile extends AbstractByteSource {
    private final File file;

    public AbstractByteSourceFile(final File file) {
        super(file.getName());
        this.file = file;
    }

    public AbstractByteSourceFile(final String file) {
        super(file);
