...
class RecordMetaDataImpl<C extends Context> implements RecordMetaData {
	...
	private <T> T convert(MetaData md, String[] data, Class<T> type, T defaultValue, Annotation annotation) {
		...
		if (type != null) {
			...
			if (annotation == null) {
				...
				if (m == null) {
					m = new LinkedHashMap<Annotation, Conversion>();
	...
	static Annotation buildBooleanStringAnnotation(final String[] trueStrings, final String[] falseStrings) {
		return new com.chua.common.support.file.univocity.parsers.annotations.BooleanString() {
			@Override
			...
			public Class<? extends Annotation> annotationType() {
				return com.chua.common.support.file.univocity.parsers.annotations.BooleanString.class;
			}
		};
	}

	private static Annotation newFormatAnnotation(final String format, final String... formatOptions) {
		return new com.chua.common.support.file.univocity.parsers.annotations.Format() {
			@Override
			...
			@Override
			public Class<? extends Annotation> annotationType() {
				return com.chua.common.support.file.univocity.parsers.annotations.Format.class;
			}
		};
	}
