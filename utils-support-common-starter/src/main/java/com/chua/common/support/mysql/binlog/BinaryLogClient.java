package com.chua.common.support.mysql.binlog;

import com.chua.common.support.mysql.binlog.event.*;
import com.chua.common.support.mysql.binlog.event.deserialization.*;
import com.chua.common.support.mysql.binlog.event.deserialization.EventDeserializer.EventDataWrapper;
import com.chua.common.support.mysql.binlog.io.ByteArrayInputStream;
import com.chua.common.support.mysql.binlog.jmx.BinaryLogClientMXBean;
    ...
    *
    ...
    private boolean tryUpgradeToSSL(GreetingPacket greetingPacket) throws IOException {
        ...
        if (sslMode != SSLMode.DISABLED) {
            ...
            boolean bool = !serverSupportsSSL && (sslMode == SSLMode.REQUIRED || sslMode == SSLMode.VERIFY_CA ||
