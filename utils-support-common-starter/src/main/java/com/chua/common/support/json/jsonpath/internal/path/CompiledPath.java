...
import com.chua.common.support.json.jsonpath.internal.EvaluationAbortException;
...
public class CompiledPath implements Path {
    ...
    @Override
    public EvaluationContext evaluate(Object document, Object rootDocument, JsonConfiguration configuration, boolean forUpdate) {
        if (logger.isDebugEnabled()) {
            logger.debug("Evaluating path: {}", this);
        }
        ...
        } catch (EvaluationAbortException ignored) {
        }
    ...
    @Override
    public EvaluationContext evaluate(Object document, Object rootDocument, JsonConfiguration configuration) {
