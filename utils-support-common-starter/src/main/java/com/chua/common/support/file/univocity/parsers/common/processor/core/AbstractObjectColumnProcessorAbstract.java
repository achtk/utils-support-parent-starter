...
/**
 * A {@link Processor} implementation for converting rows extracted from any implementation of {@link BaseParser} into columns of objects.
 ...
 *
 * <p><b>Note:</b> Storing the values of all columns may be memory intensive. For large inputs, use a {@link AbstractBatchedObjectColumnProcessorAbstract} instead</p>
 *
 ...
 */
public abstract class AbstractObjectColumnProcessorAbstract<T extends AbstractContext> extends AbstractObjectProcessorAbstract<T> implements ColumnReader<Object> {
	 ...
	 */
	public AbstractObjectColumnProcessorAbstract() {
		this(1000);
	}
	...
	public AbstractObjectColumnProcessorAbstract(int expectedRowCount) {
