...
import com.chua.common.support.file.xz.index.IndexDecoder;
...
public class SeekableXzInputStream extends SeekableInputStream {
    ...
    public void seek(long pos) throws IOException {
        ...
        if (pos < 0)
            throw new XzException("Negative seek position: " + pos);
    ...
    public void seekToBlock(int blockNumber) throws IOException {
        ...
        if (blockNumber < 0 || blockNumber >= blockCount)
            throw new XzException("Invalid Xz Block number: " + blockNumber);
