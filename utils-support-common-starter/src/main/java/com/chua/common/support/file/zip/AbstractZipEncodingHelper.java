 ...
 */
public abstract class AbstractZipEncodingHelper {
    ...
    static {
        ...
        final SimpleEncodingHolder cp437 = new SimpleEncodingHolder(cp437HighChars);
        ...
        final SimpleEncodingHolder cp850 = new SimpleEncodingHolder(cp850HighChars);
