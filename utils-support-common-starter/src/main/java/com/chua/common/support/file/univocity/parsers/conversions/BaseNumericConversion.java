 ...
 * <p> Extending classes must implement the {@link BaseNumericConversion#configureFormatter(DecimalFormat)} method to provide specific configuration to the DecimalFormat instance.
 * <p> The reverse conversion from a Number to String (in {@link BaseNumericConversion#revert(Number)} will return a formatted String using the pattern provided in this class constructor
 ...
 * @see DecimalFormat
 */
public abstract class BaseNumericConversion<T extends Number> extends ObjectConversion<T> implements FormattedConversion<DecimalFormat> {
	 ...
	 * @param valueIfObjectIsNull default String value to be returned when a Number input is null. Used when {@link BaseNumericConversion#revert(Number)} is invoked.
	 * @param numericFormats      list of acceptable numeric patterns. The first pattern in this sequence will be used to convert a Number into a String in {@link BaseNumericConversion#revert(Number)}.
	 */
	public BaseNumericConversion(T valueIfStringIsNull, String valueIfObjectIsNull, String... numericFormats) {
	 ...
	 * @param valueIfStringIsNull default Number to be returned when the input String is null. Used when {@link ObjectConversion#execute(String)} is invoked.
	 * @param valueIfObjectIsNull default String value to be returned when a Number input is null. Used when {@link BaseNumericConversion#revert(Number)} is invoked.
	 * @param numericFormatters   list formatters of acceptable numeric patterns. The first formatter in this sequence will be used to convert a Number into a String in {@link BaseNumericConversion#revert(Number)}.
	 */
	public BaseNumericConversion(T valueIfStringIsNull, String valueIfObjectIsNull, DecimalFormat... numericFormatters) {
		super(valueIfStringIsNull, valueIfObjectIsNull);
	 ...
	 * @param valueIfObjectIsNull default String value to be returned when a Number input is null. Used when {@link BaseNumericConversion#revert(Number)} is invoked.
	 */
	public BaseNumericConversion(T valueIfStringIsNull, String valueIfObjectIsNull) {
		super(valueIfStringIsNull, valueIfObjectIsNull);
	 ...
	 * @param numericFormats list of acceptable numeric patterns. The first pattern in this sequence will be used to convert a Number into a String in {@link BaseNumericConversion#revert(Number)}.
	 */
	public BaseNumericConversion(String... numericFormats) {
	 ...
	 * @param numericFormatters list formatters of acceptable numeric patterns. The first formatter in this sequence will be used to convert a Number into a String in {@link BaseNumericConversion#revert(Number)}.
	 */
	public BaseNumericConversion(DecimalFormat... numericFormatters) {
	 ...
	 *
	 * @param format        a numeric pattern. The first pattern added to this class will be used to convert a Number into a String in {@link BaseNumericConversion#revert(Number)}.
