...
public class FieldReflectionUtil {
    ...
    public static Object parseValue(Field field, String value) {
        ...
        XpathQuery apiRequestParam = field.getAnnotation(XpathQuery.class);
    ...
    public static Date parseDate(XpathQuery xpathQuery, String value) {
        try {
            String datePattern = "yyyy-MM-dd HH:mm:ss";
            if (xpathQuery != null) {
                datePattern = xpathQuery.datePattern();
            }
