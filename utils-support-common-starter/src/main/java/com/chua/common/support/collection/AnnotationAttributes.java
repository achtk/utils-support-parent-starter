...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
     ...
     * @since 4.3.2
     */
    public AnnotationAttributes(String annotationType) {
        this(annotationType, ClassLoader.getSystemClassLoader());
    }
    ...
    public boolean getBoolean(String attributeName, boolean defaultValue) {
        return ObjectUtils.defaultIfNull(getRequiredAttribute(attributeName, Boolean.class), defaultValue);
    }
    /**
     * Get the value stored under the specified {@code attributeName} as a boolean.
     *
    ...
    /**
     * Get the value stored under the specified {@code attributeName} as a int.
     *
     * @param attributeName the name of the attribute to get;
     *                      never {@code null} or empty
    ...
    public int getIntValue(String attributeName, int defaultValue) {
        Integer integer = getRequiredAttribute(attributeName, Integer.class);
    ...
    public int getIntValue(String attributeName) {
       return getIntValue(attributeName, 0);
    }
    /**
