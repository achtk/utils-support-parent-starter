 ...
 * <p> This instance will then be sent to the {@link com.chua.common.support.file.univocity.parsers.common.processor.core.AbstractBeanProcessor#beanProcessed(Object, AbstractContext)} method, where the user can access it.
 *
 * @param <T> the annotated class type.
 * @author Univocity Software Pty Ltd - <a href="mailto:parsers@univocity.com">parsers@univocity.com</a>
 * @see AbstractParser
 * @see RowProcessor
 * @see com.chua.common.support.file.univocity.parsers.common.processor.core.AbstractBeanProcessor
 */
public abstract class AbstractBeanProcessor<T> extends com.chua.common.support.file.univocity.parsers.common.processor.core.AbstractBeanProcessor<T, ParsingContext> implements RowProcessor {
