...
public class ProgressBar implements AutoCloseable {
     ...
     */
    public ProgressBar(String task, long initialMax, ProgressStyle progressStyle) {
        this(
                task, initialMax, 1000, false, false,
                System.err, ProgressBarStyle.ASCII,
                "", 1, false, null,
                ChronoUnit.SECONDS, 0L, Duration.ZERO, progressStyle
        );
    }
     ...
     * @param initialMax Initial maximum value
     */
    public ProgressBar(String task, long initialMax, ProgressBarStyle progressBarStyle, ProgressStyle progressStyle) {
        this(
                task, initialMax, 1000, false, false,
                System.err, progressBarStyle,
                "", 1, false, null,
                ChronoUnit.SECONDS, 0L, Duration.ZERO, progressStyle
        );
    }
     ...
     * @param initialMax Initial maximum value
     */
    public ProgressBar(String task, long initialMax, ProgressBarStyle progressBarStyle) {
        this(
                task, initialMax, 1000, false, false,
                System.err, progressBarStyle,
                "", 1, false, null,
                ChronoUnit.SECONDS, 0L, Duration.ZERO, ProgressStyle.ORGION
        );
    }
     ...
     * @param initialMax Initial maximum value
     */
    public ProgressBar(long initialMax) {
        this(
                null, initialMax, 1000, false, false,
                System.err, ProgressBarStyle.ASCII,
                "", 1, false, null,
                ChronoUnit.SECONDS, 0L, Duration.ZERO, ProgressStyle.ORGION
        );
    ...
    public ProgressBar(
        ...
        this(task, initialMax, updateIntervalMillis, continuousUpdate, clearDisplayOnFinish, processed, elapsed,
                ...
                createConsoleConsumer(os), progressStyle, false
        );
    }
    ...
    public ProgressBar(
        ...
        this.progress = new ProgressState(task, initialMax, processed, elapsed, progressStyle, ansi);
