...
import com.chua.common.support.file.zip.AbstractZipEncodingHelper;
import com.chua.common.support.file.zip.ZipEncoding;
...
public class TarOutputStream extends FilterOutputStream {
    ...
    private static final ZipEncoding ASCII =
            AbstractZipEncodingHelper.getZipEncoding("ASCII");
    ...
    public void putNextEntry(TarEntry entry) throws IOException {
        ...
        Map<String, String> paxHeaders = new LinkedHashMap<>();
        ...
        boolean b = addPaxHeadersForNonAsciiNames && !paxHeaderContainsLinkPath
