...
import com.chua.common.support.json.jsonpath.internal.function.PathFunctionFactory;
import com.chua.common.support.json.jsonpath.internal.function.latebinding.JsonLateBindingValue;
import com.chua.common.support.json.jsonpath.internal.function.latebinding.PathLateBindingValue;
            ...
            for (Parameter param : functionParams) {
                switch (param.getType()) {
                    case PATH:
                        ...
                        if (!param.hasEvaluated() || !pathLateBindingValue.equals(param.getLateBingValue())) {
