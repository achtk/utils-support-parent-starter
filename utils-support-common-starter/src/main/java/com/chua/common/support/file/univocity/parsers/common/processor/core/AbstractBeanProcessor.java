 ...
 * <p> This instance will then be sent to the {@link AbstractBeanProcessor#beanProcessed(Object, AbstractContext)} method, where the user can access it.
 *
 ...
 * @see Processor
 */
public abstract class AbstractBeanProcessor<T, C extends AbstractContext> extends BeanConversionProcessor<T> implements Processor<C> {
