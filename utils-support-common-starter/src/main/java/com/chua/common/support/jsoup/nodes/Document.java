...
public class Document extends Element {
    ...
    public Document(String baseUri) {
        super(Tag.valueOf("#root", ParseSettings.HTML_DEFAULT), baseUri);
    ...
    public Element createElement(String tagName) {
        return new Element(Tag.valueOf(tagName, ParseSettings.PRESERVE_CASE), this.baseUri());
    }
    ...
    public Document normalise() {
        ...
        Element head = head();
        body();        // of. do in inverse order to maintain text order.
