...
abstract class BaseToken {
    ...
    static final class Doctype extends BaseToken {
    ...
    static abstract class BaseTag extends BaseToken {
        ...
        final BaseTag name(String name) {
            tagName = name;
    ...
    final static class StartTag extends BaseTag {
        StartTag() {
            super();
    ...
    final static class EndTag extends BaseTag {
        EndTag() {
            super();
    ...
    final static class Comment extends BaseToken {
    ...
    static class Character extends BaseToken {
        private String data;
    ...
    final static class Eof extends BaseToken {
        Eof() {
            type = TokenType.EOF;
        }
