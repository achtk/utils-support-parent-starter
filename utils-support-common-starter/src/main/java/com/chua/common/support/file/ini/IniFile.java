package com.chua.common.support.file.ini;
...
public class IniFile {
    ...
    /**
     * Constructs new bare IniFile instance.
     */
    public IniFile() {
        this(null, null);
    }
    ...
    /**
     * Constructs new bare IniFile instance specifying case-sensitivity.
     *
     ...
     *                        this is true
     */
    public IniFile(String commonName, boolean isCaseSensitive) {
        this(commonName, null, isCaseSensitive);
    }

    /**
     * Constructs new IniFile defining comment delimiters.
     *
     ...
     *                        this is true
     */
    public IniFile(char[] delims, boolean isCaseSensitive) {
        this(null, delims, isCaseSensitive);
    }

    /**
     * Constructs new IniFile instance with a common section, defining
     ...
     *                   comments
     */
    public IniFile(String commonName, char[] delims) {
     ...
     *                   comments
     */
    public IniFile(String commonName, char[] delims, boolean isCaseSensitive) {
     ...
     * class does actually belong to the internals of {@link IniFile} and
