...
import com.chua.common.support.json.jsonpath.InvalidModificationException;
import com.chua.common.support.json.jsonpath.JsonConfiguration;
import com.chua.common.support.json.jsonpath.MapFunction;
import com.chua.common.support.json.jsonpath.PathNotFoundException;
...
public abstract class PathRef implements Comparable<PathRef> {
    ...
    public static final PathRef NO_OP = new PathRef(null) {
        ...
        @Override
        public void set(Object newVal, JsonConfiguration configuration) {
        }

        @Override
        public void convert(MapFunction mapFunction, JsonConfiguration configuration) {
        }

        @Override
        public void delete(JsonConfiguration configuration) {
        }

        @Override
        public void add(Object newVal, JsonConfiguration configuration) {
        }

        @Override
        public void put(String key, Object newVal, JsonConfiguration configuration) {
        }

        @Override
        public void renameKey(String oldKeyName, String newKeyName, JsonConfiguration configuration) {
        }
    ...
    public abstract void set(Object newVal, JsonConfiguration configuration);

    public abstract void convert(MapFunction mapFunction, JsonConfiguration configuration);

    public abstract void delete(JsonConfiguration configuration);

    public abstract void add(Object newVal, JsonConfiguration configuration);

    public abstract void put(String key, Object newVal, JsonConfiguration configuration);

    public abstract void renameKey(String oldKey, String newKeyName, JsonConfiguration configuration);

    protected void renameInMap(Object targetMap, String oldKeyName, String newKeyName, JsonConfiguration configuration) {
    ...
    private static class ArrayIndexPathRef extends PathRef {
        ...
        public void add(Object value, JsonConfiguration configuration) {
        ...
        public void put(String key, Object value, JsonConfiguration configuration) {
            Object target = configuration.jsonProvider().getArrayIndex(parent, index);
            if (targetInvalid(target)) {
                return;
            }
