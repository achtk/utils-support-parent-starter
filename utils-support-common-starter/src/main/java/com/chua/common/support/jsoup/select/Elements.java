...
public class Elements extends ArrayList<Element> {
     ...
     * <p>
     * Note that this method should not be used to clean user-submitted HTML; rather, use {@link com.chua.common.support.jsoup.safety.Cleaner} to clean HTML.
     * @return this, for chaining
     * @see Element#empty()
     * @see #empty()
     */
    ...
    public boolean is(String query) {
        AbstractEvaluator eval = QueryParser.parse(query);
        for (Element e : this) {
            if (e.is(eval)) {
                return true;
            }
    ...
    private Elements siblings(String query, boolean next, boolean all) {
        ...
        AbstractEvaluator eval = query != null? QueryParser.parse(query) : null;
        for (Element e : this) {
            do {
