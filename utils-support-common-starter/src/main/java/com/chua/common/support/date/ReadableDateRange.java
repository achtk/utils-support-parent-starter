...
import static com.chua.common.support.date.DateTimeType.*;
import static com.chua.common.support.date.DateUtils.DEFAULT_ZONE_ID;
import static com.chua.common.support.date.DateUtils.WEEK_DAY;
...
public interface ReadableDateRange extends ReadableDateTime {
    ...
    default List<String> asRangeWeek(String format) {
        return asRangeWeek(DEFAULT_ZONE_ID, format);
    }
    ...
    default List<Date> asRangeWeek() {
        return asRangeWeek(DEFAULT_ZONE_ID);
    }
    ...
    default List<Date> asRangeDayUntil(int length) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            localDateTime1 = localDateTime1.withHour(0)
                    ...
                    .withNano(0);
            result.add(DateUtils.toDate(localDateTime1, DEFAULT_ZONE_ID));
        }
        return result;
    }
