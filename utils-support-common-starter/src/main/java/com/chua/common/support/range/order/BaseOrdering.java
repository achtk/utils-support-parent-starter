 ...
 * @author CH
 */
public abstract class BaseOrdering<T extends Object> implements Comparator<T> {
    /**
    ...
    public static <C extends Comparable> BaseOrdering<C> natural() {
        return (BaseOrdering<C>) NaturalOrdering.INSTANCE;
    }
    ...
    public static <T extends Object> BaseOrdering<T> from(Comparator<T> comparator) {
        return (comparator instanceof BaseOrdering)
                ? (BaseOrdering<T>) comparator
    ...
    @Deprecated
    public static <T extends Object> BaseOrdering<T> from(BaseOrdering<T> ordering) {
    ...
    public static BaseOrdering<Object> usingToString() {
    ...
    public <F extends Object> BaseOrdering<F> onResultOf(Function<F, ? extends T> function) {
        return new ByFunctionOrdering<>(function, this);
    }

    <T2 extends T> BaseOrdering<Map.Entry<T2, ?>> onKeys() {
     ...
     * one created using {@link BaseOrdering#compound(Iterable)} on the same component comparators.
     *
    ...
    public <U extends T> BaseOrdering<U> compound(Comparator<? super U> secondaryComparator) {
    ...
    public static <T extends Object> BaseOrdering<T> compound(
     ...
     * @since 2.0
     */
    public <S extends T> BaseOrdering<Iterable<S>> lexicographical() {
        /*
     ...
     * thisComparator} is {@link BaseOrdering#natural}, then use {@code Comparators.min(a, b)}.
     *
     ...
     * thisComparator} is {@link BaseOrdering#natural}, then use {@code Comparators.max(a, b)}.
     *
