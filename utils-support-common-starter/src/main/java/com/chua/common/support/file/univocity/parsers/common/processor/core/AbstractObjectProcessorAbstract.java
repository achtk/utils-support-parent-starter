...
/**
 * A {@link Processor} implementation for converting rows extracted from any implementation of {@link BaseParser} into arrays of objects.
 ...
 * <p> The row with the result of these conversions will then be sent to the {@link AbstractObjectProcessorAbstract#rowProcessed(Object[], AbstractContext)} method, where the user can access it.
 *
 * @author Univocity Software Pty Ltd - <a href="mailto:parsers@univocity.com">parsers@univocity.com</a>
 * @see BaseParser
 * @see Processor
 */
public abstract class AbstractObjectProcessorAbstract<T extends AbstractContext> extends AbstractDefaultConversionProcessor implements Processor<T> {

	/**
	 * Executes the sequences of conversions defined using {@link AbstractDefaultConversionProcessor#convertFields(Conversion...)},
	 * {@link AbstractDefaultConversionProcessor#convertIndexes(Conversion...)} and {@link AbstractDefaultConversionProcessor#convertAll(Conversion...)},
