...
public class CityMockResolver implements MockResolver {
    ...
    public static String getRandom() {
        return CITY[RandomUtils.randomInt(0, CITY.length)];
    }
}
