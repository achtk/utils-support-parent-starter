 ...
 * parser.parse(reader); // will invoke the {@link AbstractObjectListProcessorAbstract#rowProcessed(Object[], T)} method for each parsed record.
 *
 ...
 */
public abstract class AbstractObjectListProcessorAbstract<T extends AbstractContext> extends AbstractObjectProcessorAbstract<T> {
	 ...
	 */
	public AbstractObjectListProcessorAbstract() {
		this(0);
	}
	 ...
	 */
	public AbstractObjectListProcessorAbstract(int expectedRowCount) {
	...
	/**
	 * Returns the record headers. This can be either the headers defined in {@link BaseCommonSettings#getHeaders()} or the headers parsed in the file when {@link BaseCommonSettings#getHeaders()}  equals true
	 *
