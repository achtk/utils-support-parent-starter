...
import com.chua.common.support.jsoup.HttpStatusException;
import com.chua.common.support.jsoup.UncheckedException;
import com.chua.common.support.jsoup.UnsupportedMimeTypeException;
...
import static com.chua.common.support.jsoup.Connection.Method.HEAD;
...
public class HttpConnection implements Connection {
    ...
    private static URL punyUrl(URL url) {
        if (!StringUtils.isAscii(url.getHost())) {
            try {
    ...
    public static class Response extends Base<Connection.Response> implements Connection.Response {
        ...
        static Response execute(Request req, Response previousResponse) throws IOException {
            ...
            try {
                ...
                if (res.hasHeader(LOCATION) && req.followRedirects()) {
                    ...
                    URL redir = StringUtils.resolve(req.url(), location);
                ...
                if (conn.getContentLength() != 0 && req.method() != HEAD) { // -1 means unknown, chunked. sun throws an IO exception on 500 response with no content when trying to read body
                    ...
                    res.bodyStream = ConstrainableInputStream
                        .wrap(res.bodyStream, DataUtil.BUFFER_SIZE, req.maxBodySize())
        ...
        public BufferedInputStream bodyStream() {
            ...
            inputStreamRead = true;
            return ConstrainableInputStream.wrap(bodyStream, DataUtil.BUFFER_SIZE, req.maxBodySize());
        }
        ...
        private static void serialiseRequestUrl(Connection.Request req) throws IOException {
            URL in = req.url();
            StringBuilder url = StringUtils.borrowBuilder();
            boolean first = true;
            ...
            for (Connection.KeyVal keyVal : req.data()) {
                ...
                if (!first)
                    ...
                    first = false;
                url
                    .append(URLEncoder.encode(keyVal.key(), DataUtil.DEFAULT_CHARSET_NAME))
                    .append('=')
