...
public abstract class ClasspathHelper {
     ...
     * For example, {@code forPackage(com.chua.common.support.reflections)} effectively returns URLs from the
     * classpath containing packages starting with {@code com.chua.common.support.reflections}.
     * <p>
