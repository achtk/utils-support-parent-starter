...
public class CardUtils {
    ...
    public static String convert15To18(String idCard) {
        ...
        if (RegexUtils.isMatch(NUMBERS, idCard)) {
            // 获取出生年月日
            ...
            idCard18 = stringBuilder.append(idCard, 0, 6).append(sYear).append(idCard.substring(8));
            // 获取校验位
    ...
    public static boolean isValidCard18(String idcard, boolean ignoreCase) {
        ...
        if (RegexUtils.isMatch(NUMBERS, code17)) {
            // 获取校验位
    ...
    public static String getBirth(String idCard) {
        Preconditions.checkNotNull(idCard, "id card must be not blank!");
    ...
    public static DateTime getBirthDate(String idCard) {
        ...
        return null == birthByIdCard ? null : DateTime.of(birthByIdCard);
    }
    ...
    public static int getAgeByIdCard(String idcard) {
        return getAgeByIdCard(idcard, DateTime.now().toDate());
    }
    ...
    public static int getGenderByIdCard(String idcard) {
        Preconditions.checkNotNull(idcard);
        final int len = idcard.length();
        if (len < CHINA_ID_MIN_LENGTH) {
    ...
    public static class Idcard implements Serializable {
        ...
        public Idcard(String idcard) {
            this.provinceCode = CardUtils.getProvinceCodeByIdCard(idcard);
            this.cityCode = CardUtils.getCityCodeByIdCard(idcard);
            this.birthDate = CardUtils.getBirthDate(idcard);
            this.gender = CardUtils.getGenderByIdCard(idcard);
            this.age = CardUtils.getAgeByIdCard(idcard);
        }
