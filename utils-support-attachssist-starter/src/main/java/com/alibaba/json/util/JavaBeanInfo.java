...
import com.alibaba.json.annotation.JSONPOJOBuilder;
...
public class JavaBeanInfo {
    ...
    public JavaBeanInfo(Class<?> clazz, //
        ...
        this.parserFeatures = com.alibaba.json.util.TypeUtils.getParserFeatures(clazz);
        ...
        if (creatorConstructor != null) {
            ...
            kotlin = com.alibaba.json.util.TypeUtils.isKotlin(clazz);
            if (kotlin) {
                this.creatorConstructorParameters = com.alibaba.json.util.TypeUtils.getKoltinConstructorParameters(clazz);
                try {
                ...
                Annotation[][] paramAnnotationArrays = com.alibaba.json.util.TypeUtils.getParameterAnnotations(creatorConstructor);
    ...
    public static JavaBeanInfo build(Class<?> clazz, Type type, PropertyNamingStrategy propertyNamingStrategy) {
        return build(clazz, type, propertyNamingStrategy, false, com.alibaba.json.util.TypeUtils.compatibleWithJavaBean, false);
    }
    ...
    public static JavaBeanInfo build(Class<?> clazz //
        ...
        JSONType jsonType = com.alibaba.json.util.TypeUtils.getAnnotation(clazz, JSONType.class);
        if (jsonType != null) {
        ...
        boolean kotlin = com.alibaba.json.util.TypeUtils.isKotlin(clazz);
        ...
        if (fieldBased) {
            ...
            if (defaultConstructor != null) {
                com.alibaba.json.util.TypeUtils.setAccessible(defaultConstructor);
            }
        ...
        if ((defaultConstructor == null && builderClass == null) || isInterfaceOrAbstract) {
            ...
            if (creatorConstructor != null && !isInterfaceOrAbstract) { // 基于标记 JSONCreator 注解的构造方法
                com.alibaba.json.util.TypeUtils.setAccessible(creatorConstructor);
                ...
                if (types.length > 0) {
                    ...
                    for (int i = 0; i < types.length && i < paramAnnotationArrays.length; ++i) {
                        ...
                        if (fieldAnnotation != null) {
                            field = com.alibaba.json.util.TypeUtils.getField(clazz, fieldAnnotation.name(), declaredFields);
                        ...
                        if (field == null) {
                            if (lookupParameterNames == null) {
                                if (kotlin) {
                                    lookupParameterNames = com.alibaba.json.util.TypeUtils.getKoltinConstructorParameters(clazz);
                                } else {
                                    lookupParameterNames = ASMUtils.lookupParameterNames(creatorConstructor);
                                }
                            }
                            ...
                            if (lookupParameterNames.length > i) {
                                ...
                                field = com.alibaba.json.util.TypeUtils.getField(clazz, parameterName, declaredFields);
                            }
                        }
                ...
                com.alibaba.json.util.TypeUtils.setAccessible(factoryMethod);

                String[] lookupParameterNames = null;
                Class<?>[] types = factoryMethod.getParameterTypes();
                if (types.length > 0) {
                    Annotation[][] paramAnnotationArrays = com.alibaba.json.util.TypeUtils.getParameterAnnotations(factoryMethod);
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        if (fieldAnnotation == null && !(jacksonCompatible && com.alibaba.json.util.TypeUtils.isJacksonCreator(factoryMethod))) {
                        ...
                        Field field = com.alibaba.json.util.TypeUtils.getField(clazz, fieldName, declaredFields);
                        FieldInfo fieldInfo = new FieldInfo(fieldName, clazz, fieldClass, fieldType, field,
                                ordinal, serialzeFeatures, parserFeatures);
                        add(fieldList, fieldInfo);
                    }
                ...
                if (kotlin && constructors.length > 0) {
                    paramNames = com.alibaba.json.util.TypeUtils.getKoltinConstructorParameters(clazz);
                    creatorConstructor = com.alibaba.json.util.TypeUtils.getKotlinConstructor(constructors, paramNames);
                    com.alibaba.json.util.TypeUtils.setAccessible(creatorConstructor);
                } else {
                ...
                if (paramNames != null
                    ...
                    for (int i = 0; i < types.length; ++i) {
                        ...
                        Class<?> fieldClass = types[i];
                        Type fieldType = creatorConstructor.getGenericParameterTypes()[i];
                        Field field = com.alibaba.json.util.TypeUtils.getField(clazz, paramName, declaredFields);
                        if (field != null) {
                            if (fieldAnnotation == null) {
                                fieldAnnotation = com.alibaba.json.util.TypeUtils.getAnnotation(field, JSONField.class);
                            }
                        }
        ...
        if (builderClass != null) {
            ...
            JSONPOJOBuilder builderAnno = com.alibaba.json.util.TypeUtils.getAnnotation(builderClass, JSONPOJOBuilder.class);
            if (builderAnno != null) {
            ...
            for (Method method : builderClass.getMethods()) {
                ...
                JSONField annotation = com.alibaba.json.util.TypeUtils.getAnnotation(method, JSONField.class);

                if (annotation == null) {
                    annotation = com.alibaba.json.util.TypeUtils.getSuperMethodAnnotation(clazz, method);
                }
            ...
            if (builderClass != null) {
                JSONPOJOBuilder builderAnnotation = com.alibaba.json.util.TypeUtils.getAnnotation(builderClass, JSONPOJOBuilder.class);
                ...
                com.alibaba.json.util.TypeUtils.setAccessible(buildMethod);
            }
        }
        ...
        for (Method method : methods) { //
            ...
            if (Character.isUpperCase(c3) //
                ...
                if (kotlin) {
                    ...
                    propertyName = com.alibaba.json.util.TypeUtils.getPropertyNameByMethodName(getMethodName);
                } else {
                    if (com.alibaba.json.util.TypeUtils.compatibleWithJavaBean) {
                        propertyName = com.alibaba.json.util.TypeUtils.decapitalize(methodName.substring(3));
                    } else {
                        propertyName = com.alibaba.json.util.TypeUtils.getPropertyNameByMethodName(methodName);
                    }
                }
                ...
                if (kotlin) {
                    ...
                    field = com.alibaba.json.util.TypeUtils.getField(clazz, propertyName, declaredFields);
                } else {
            ...
            if (field == null && types[0] == boolean.class) {
                ...
                field = com.alibaba.json.util.TypeUtils.getField(clazz, isFieldName, declaredFields);
            }
            ...
            if (builderClass == null && methodName.startsWith("get") && Character.isUpperCase(methodName.charAt(3))) {
                ...
                if (Collection.class.isAssignableFrom(method.getReturnType()) //
                    ...
                    if (annotation != null && annotation.name().length() > 0) {
                        ...
                        Field field = com.alibaba.json.util.TypeUtils.getField(clazz, propertyName, declaredFields);
                        if (field != null) {
                            JSONField fieldAnnotation = com.alibaba.json.util.TypeUtils.getAnnotation(field, JSONField.class);
    ...
    public static Constructor<?> getCreatorConstructor(Constructor[] constructors) {
        ...
        for (Constructor constructor : constructors) {
            Annotation[][] paramAnnotationArrays = com.alibaba.json.util.TypeUtils.getParameterAnnotations(constructor);
    ...
    private static Method getFactoryMethod(Class<?> clazz, Method[] methods, boolean jacksonCompatible) {
        ...
        for (Method method : methods) {
            ...
            JSONCreator annotation = com.alibaba.json.util.TypeUtils.getAnnotation(method, JSONCreator.class);
            if (annotation != null) {
