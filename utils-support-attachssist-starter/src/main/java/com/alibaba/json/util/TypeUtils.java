...
import com.alibaba.json.serializer.CalendarCodec;
import com.alibaba.json.serializer.SerializeBeanInfo;
...
//    }
            ...
            if (value instanceof String) {
                ...
                if (isNumber(strVal)) {
                    ...
                    if (scanner.scanISO8601DateIfMatch(false)) {
                        ...
                        throw new com.alibaba.json.JSONException("can not cast to Timestamp, value : " + strVal);
                    }
                }
            }
    ...
    private static Function<Object, Object> castToSqlDateFunction = new Function<Object, Object>() {
        public Object apply(Object value) {
            ...
            if (longValue <= 0) {
                throw new com.alibaba.json.JSONException("can not cast to Date, value : " + value); // TODO 忽略 1970-01-01 之前的时间处理？
            }
    ...
    public static Byte castToByte(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to byte, value : " + value);
    }
    ...
    public static Character castToChar(Object value) {
        ...
        if (value instanceof String) {
            ...
            if (strVal.length() != 1) {
                throw new com.alibaba.json.JSONException("can not cast to char, value : " + value);
            }
    ...
    public static Short castToShort(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to short, value : " + value);
    }
    ...
    public static BigDecimal castToBigDecimal(Object value) {
        ...
        if (strVal.length() > 65535) {
            throw new com.alibaba.json.JSONException("decimal overflow");
        }
    ...
    public static Float castToFloat(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to float, value : " + value);
    }
    ...
    public static Double castToDouble(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to double, value : " + value);
    }
        ...
        if (value instanceof String) {
            ...
            if (strVal.indexOf('-') > 0 || strVal.indexOf('+') > 0 || format != null) {
                if (format == null) {
                    ...
                    if (len == com.alibaba.json.JSON.DEFFAULT_DATE_FORMAT.length()
                            || (len == 22 && com.alibaba.json.JSON.DEFFAULT_DATE_FORMAT.equals("yyyyMMddHHmmssSSSZ"))) {
                        format = com.alibaba.json.JSON.DEFFAULT_DATE_FORMAT;
                    } else if (len == 10) {
                        format = "yyyy-MM-dd";
                ...
                SimpleDateFormat dateFormat = new SimpleDateFormat(format, com.alibaba.json.JSON.defaultLocale);
                dateFormat.setTimeZone(com.alibaba.json.JSON.defaultTimeZone);
                try {
                    return dateFormat.parse(strVal);
                } catch (ParseException e) {
                    throw new com.alibaba.json.JSONException("can not cast to Date, value : " + strVal);
                }
            }
            if (strVal.length() == 0) {
                return null;
        ...
        if (longValue == -1) {
            ...
            if ("oracle.sql.TIMESTAMP".equals(clazz.getName())) {
                ...
                try {
                    ...
                    throw new com.alibaba.json.JSONException("can not cast oracle.sql.TIMESTAMP to Date", e);
                }
                return (Date) result;
            }
            if ("oracle.sql.DATE".equals(clazz.getName())) {
                ...
                try {
                    ...
                    throw new com.alibaba.json.JSONException("can not cast oracle.sql.DATE to Date", e);
                }
                return (Date) result;
            }

            throw new com.alibaba.json.JSONException("can not cast to Date, value : " + value);
        }
    ...
    public static Long castToLong(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to long, value : " + value);
    }
    ...
    public static Integer castToInt(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to int, value : " + value);
    }
    ...
    public static Boolean castToBoolean(Object value) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to boolean, value : " + value);
    }
    ...
    public static <T> T cast(final Object obj, final Class<T> clazz, ParserConfig config) {
        ...
        if (obj instanceof Map) {
            ...
            Map map = (Map) obj;
            if (clazz == Object.class && !map.containsKey(com.alibaba.json.JSON.DEFAULT_TYPE_KEY)) {
                return (T) obj;
            }
        ...
        if (Calendar.class.isAssignableFrom(clazz)) {
            ...
            if (clazz == Calendar.class) {
                calendar = Calendar.getInstance(com.alibaba.json.JSON.defaultTimeZone, com.alibaba.json.JSON.defaultLocale);
            } else {
                try {
                    calendar = (Calendar) clazz.newInstance();
                } catch (Exception e) {
                    throw new com.alibaba.json.JSONException("can not cast to : " + clazz.getName(), e);
                }
            }
        ...
        if (className.equals("javax.xml.datatype.XMLGregorianCalendar")) {
            Date date = castToDate(obj);
            Calendar calendar = Calendar.getInstance(com.alibaba.json.JSON.defaultTimeZone, com.alibaba.json.JSON.defaultLocale);
            calendar.setTime(date);
        ...
        if (obj instanceof String) {
            ...
            if (className.startsWith("java.time.")) {
                String json = com.alibaba.json.JSON.toJSONString(strVal);
                return com.alibaba.json.JSON.parseObject(json, clazz);
            }
        }

        final com.alibaba.json.parser.deserializer.ObjectDeserializer objectDeserializer = config.get(clazz);
        if (objectDeserializer != null) {
            String str = com.alibaba.json.JSON.toJSONString(obj);
            return com.alibaba.json.JSON.parseObject(str, clazz);
        }
        throw new com.alibaba.json.JSONException("can not cast to : " + clazz.getName());
    }
    ...
    public static <T> T castToEnum(Object obj, Class<T> clazz, ParserConfig mapping) {
        try {
            if (obj instanceof String) {
                ...
                com.alibaba.json.parser.deserializer.ObjectDeserializer deserializer = mapping.getDeserializer(clazz);
                if (deserializer instanceof com.alibaba.json.parser.deserializer.EnumDeserializer) {
                    com.alibaba.json.parser.deserializer.EnumDeserializer enumDeserializer = (EnumDeserializer) deserializer;
            ...
            throw new com.alibaba.json.JSONException("can not cast to : " + clazz.getName(), ex);
        }
        throw new com.alibaba.json.JSONException("can not cast to : " + clazz.getName());
    }
    ...
    public static <T> T cast(Object obj, Type type, ParserConfig mapping) {
        ...
        throw new com.alibaba.json.JSONException("can not cast to : " + type);
    }
    ...
    public static <T> T cast(Object obj, ParameterizedType type, ParserConfig mapping) {
            ...
            if (obj instanceof List) {
                ...
                for (Object item : listObj) {
                    ...
                    if (itemType instanceof Class) {
                        if (item != null && item.getClass() == com.alibaba.json.JSONObject.class) {
                            itemValue = ((com.alibaba.json.JSONObject) item).toJavaObject((Class<T>) itemType, mapping, 0);
                        } else {
        ...
        if (rawTye instanceof Class) {
            ...
            com.alibaba.json.parser.deserializer.ObjectDeserializer deserializer = mapping.getDeserializer(rawTye);
            if (deserializer != null) {
                String str = com.alibaba.json.JSON.toJSONString(obj);
                com.alibaba.json.parser.DefaultJSONParser parser = new DefaultJSONParser(str, mapping);
    ...
    public static <T> T castToJavaBean(Map<String, Object> map, Class<T> clazz, ParserConfig config) {
        try {
            ...
            {
                Object iClassObject = map.get(com.alibaba.json.JSON.DEFAULT_TYPE_KEY);
            ...
            if (clazz.isInterface()) {
                com.alibaba.json.JSONObject object;
                if (map instanceof com.alibaba.json.JSONObject) {
                    object = (com.alibaba.json.JSONObject) map;
                } else {
                    object = new com.alibaba.json.JSONObject(map);
                }
                if (config == null) {
                    config = ParserConfig.getGlobalInstance();
                }
                com.alibaba.json.parser.deserializer.ObjectDeserializer deserializer = config.get(clazz);
                if (deserializer != null) {
                    String json = com.alibaba.json.JSON.toJSONString(object);
                    return com.alibaba.json.JSON.parseObject(json, clazz);
                }
            ...
            if (clazz == String.class && map instanceof com.alibaba.json.JSONObject) {
                return (T) map.toString();
            }

            if (clazz == com.alibaba.json.JSON.class && map instanceof com.alibaba.json.JSONObject) {
                return (T) map;
            }

            if (clazz == LinkedHashMap.class && map instanceof com.alibaba.json.JSONObject) {
                com.alibaba.json.JSONObject jsonObject = (com.alibaba.json.JSONObject) map;
            ...
            if (clazz == com.alibaba.json.JSONObject.class) {
                return (T) new com.alibaba.json.JSONObject(map);
            }
            ...
            com.alibaba.json.parser.deserializer.JavaBeanDeserializer javaBeanDeser = null;
            ...
            if (javaBeanDeser == null) {
                throw new com.alibaba.json.JSONException("can not get javaBeanDeserializer. " + clazz.getName());
            }
    ...
    public static Class<?> loadClass(String className, ClassLoader classLoader, boolean cache) {
        ...
        if (className.length() > 198) {
            throw new com.alibaba.json.JSONException("illegal className : " + className);
        }
    ...
    public static com.alibaba.json.serializer.SerializeBeanInfo buildBeanInfo(Class<?> beanType //
            , Map<String, String> aliasMap //
            , com.alibaba.json.PropertyNamingStrategy propertyNamingStrategy) {
    ...
    public static com.alibaba.json.serializer.SerializeBeanInfo buildBeanInfo(Class<?> beanType //
        ...
        com.alibaba.json.annotation.JSONType jsonType = TypeUtils.getAnnotation(beanType, com.alibaba.json.annotation.JSONType.class);
        String[] orders = null;
        final int features;
        ...
        if (jsonType != null) {
            ...
            com.alibaba.json.PropertyNamingStrategy jsonTypeNaming = jsonType.naming();
            if (jsonTypeNaming != com.alibaba.json.PropertyNamingStrategy.NeverUseThisValueExceptDefaultValue) {
                propertyNamingStrategy = jsonTypeNaming;
            }

            features = com.alibaba.json.serializer.SerializerFeature.of(jsonType.serialzeFeatures());
            for (Class<?> supperClass = beanType.getSuperclass()
                 ; supperClass != null && supperClass != Object.class
                    ; supperClass = supperClass.getSuperclass()) {
                com.alibaba.json.annotation.JSONType superJsonType = TypeUtils.getAnnotation(supperClass, com.alibaba.json.annotation.JSONType.class);
            ...
            for (Class<?> interfaceClass : beanType.getInterfaces()) {
                com.alibaba.json.annotation.JSONType superJsonType = TypeUtils.getAnnotation(interfaceClass, com.alibaba.json.annotation.JSONType.class);
                if (superJsonType != null) {
                    typeKey = superJsonType.typeKey();
                    if (typeKey.length() != 0) {
                        break;
    ...
    public static List<FieldInfo> computeGetters(Class<?> clazz, Map<String, String> aliasMap, boolean sorted) {
        ...
        return computeGetters(clazz, jsonType, aliasMap, fieldCacheMap, sorted, com.alibaba.json.PropertyNamingStrategy.CamelCase);
    }

    public static List<FieldInfo> computeGetters(Class<?> clazz, //
                                                 com.alibaba.json.annotation.JSONType jsonType, //
                                                 Map<String, String> aliasMap, //
        ...
        for (Method method : methods) {
            ...
            com.alibaba.json.annotation.JSONField annotation = TypeUtils.getAnnotation(method, com.alibaba.json.annotation.JSONField.class);
            if (annotation == null) {
                    ...
                    if (p >= 0) {
                        ...
                        if (paramAnnotations != null) {
                            for (Annotation paramAnnotation : paramAnnotations) {
                                if (paramAnnotation instanceof com.alibaba.json.annotation.JSONField) {
                                    annotation = (com.alibaba.json.annotation.JSONField) paramAnnotation;
                                    break;
                                }
                            }
                        }
                        if (annotation == null) {
                            ...
                            if (field != null) {
                                annotation = TypeUtils.getAnnotation(field, com.alibaba.json.annotation.JSONField.class);
                            }
                        }
                    }
                }
            ...
            if (annotation != null) {
                ...
                serialzeFeatures = com.alibaba.json.serializer.SerializerFeature.of(annotation.serialzeFeatures());
                parserFeatures = com.alibaba.json.parser.Feature.of(annotation.parseFeatures());
            ...
            if (methodName.startsWith("get")) {
                ...
                com.alibaba.json.annotation.JSONField fieldAnnotation = null;
                if (field != null) {
                    fieldAnnotation = TypeUtils.getAnnotation(field, com.alibaba.json.annotation.JSONField.class);
                    if (fieldAnnotation != null) {
                        if (!fieldAnnotation.serialize()) {
                            continue;
                        }
                        ordinal = fieldAnnotation.ordinal();
                        serialzeFeatures = com.alibaba.json.serializer.SerializerFeature.of(fieldAnnotation.serialzeFeatures());
                        parserFeatures = com.alibaba.json.parser.Feature.of(fieldAnnotation.parseFeatures());
    ...
    private static List<FieldInfo> getFieldInfos(Class<?> clazz, boolean sorted, Map<String, FieldInfo> fieldInfoMap) {
        ...
        String[] orders = null;
        com.alibaba.json.annotation.JSONType annotation = TypeUtils.getAnnotation(clazz, com.alibaba.json.annotation.JSONType.class);
        if (annotation != null) {
    ...
    private static void computeFields(
        ...
        for (Field field : fields) {
            ...
            com.alibaba.json.annotation.JSONField fieldAnnotation = TypeUtils.getAnnotation(field, com.alibaba.json.annotation.JSONField.class);
            int ordinal = 0, serialzeFeatures = 0, parserFeatures = 0;
    ...
    public static com.alibaba.json.annotation.JSONField getSuperMethodAnnotation(final Class<?> clazz, final Method method) {
        ...
        if (interfaces.length > 0) {
            ...
            for (Class<?> interfaceClass : interfaces) {
                for (Method interfaceMethod : interfaceClass.getMethods()) {
                    ...
                    com.alibaba.json.annotation.JSONField annotation = TypeUtils.getAnnotation(interfaceMethod, com.alibaba.json.annotation.JSONField.class);
                    if (annotation != null) {
                        return annotation;
                    }
                }
        ...
        if (Modifier.isAbstract(superClass.getModifiers())) {
            ...
            for (Method interfaceMethod : superClass.getMethods()) {
                ...
                com.alibaba.json.annotation.JSONField annotation = TypeUtils.getAnnotation(interfaceMethod, JSONField.class);
                if (annotation != null) {
                    return annotation;
                }
            }
    ...
    public static int getParserFeatures(Class<?> clazz) {
        com.alibaba.json.annotation.JSONType annotation = TypeUtils.getAnnotation(clazz, JSONType.class);
        if (annotation == null) {
            return 0;
        }
        ...
        if (fieldType instanceof ParameterizedType) {
            ...
            if (actualTypeArgument instanceof Class) {
                ...
                if (!Modifier.isPublic(itemClass.getModifiers())) {
                    throw new com.alibaba.json.JSONException("can not create ASMParser");
                }
            } else {
                throw new com.alibaba.json.JSONException("can not create ASMParser");
            }
    ...
    public static Set createSet(Type type) {
        ...
        if (rawClass == AbstractCollection.class //
            ...
            try {
                ...
                throw new com.alibaba.json.JSONException("create instance error, class " + rawClass.getName());
            }
        }
        return set;
    }
    ...
    public static Class<?> getRawClass(Type type) {
        if (type instanceof Class<?>) {
            ...
            if (upperBounds.length == 1) {
                ...
                throw new com.alibaba.json.JSONException("TODO");
            }
        } else {
    ...
    public static <A extends Annotation> A getAnnotation(Class<?> targetClass, Class<A> annotationClass) {
        ...
        Type type = com.alibaba.json.JSON.getMixInAnnotations(targetClass);
        if (type instanceof Class<?>) {
    ...
    public static <A extends Annotation> A getAnnotation(Field field, Class<A> annotationClass) {
        ...
        A mixInAnnotation;
        Class<?> mixInClass = null;
        Type type = com.alibaba.json.JSON.getMixInAnnotations(clazz);
        if (type instanceof Class<?>) {
            mixInClass = (Class<?>) type;
        }
