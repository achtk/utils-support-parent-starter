...
public abstract class JSON implements JSONStreamAware, JSONAware {
    ...
    static {
        ...
        config(com.alibaba.json.util.IOUtils.DEFAULT_PROPERTIES);
    }
    ...
    public static Object parse(byte[] input, Feature... features) {
        ...
        int len = com.alibaba.json.util.IOUtils.decodeUTF8(input, 0, input.length, chars);
        if (len < 0) {
            return null;
        }
    ...
    public static Object parse(byte[] input, int off, int len, CharsetDecoder charsetDecoder, int features) {
        ...
        com.alibaba.json.util.IOUtils.decode(charsetDecoder, byteBuf, charBuf);
    ...
    public static <T> T parseObject(byte[] bytes, Type clazz, Feature... features) {
        return (T) parseObject(bytes, 0, bytes.length, com.alibaba.json.util.IOUtils.UTF8, clazz, features);
    }
    ...
    public static <T> T parseObject(byte[] bytes, int offset, int len,
                                    ...
                                    Feature... features) {
        if (charset == null) {
            charset = com.alibaba.json.util.IOUtils.UTF8;
        }

        String strVal = null;
        if (charset == com.alibaba.json.util.IOUtils.UTF8) {
            char[] chars = allocateChars(bytes.length);
            int chars_len = com.alibaba.json.util.IOUtils.decodeUTF8(bytes, offset, len, chars);
            ...
            if (chars_len < 0) {
                ...
                try {
                    ...
                    strVal = com.alibaba.json.util.IOUtils.readAll(gzipReader);
                } catch (Exception ex) {
                    return null;
                } finally {
                    com.alibaba.json.util.IOUtils.close(gzipReader);
                }
            }
    ...
    public static <T> T parseObject(byte[] input, //
        ...
        com.alibaba.json.util.IOUtils.decode(charsetDecoder, byteBuf, charByte);
    ...
    public static <T> T parseObject(InputStream is, //
        ...
        return (T) parseObject(is, com.alibaba.json.util.IOUtils.UTF8, type, features);
    }
    ...
    public static byte[] toJSONBytes(Object object, SerializeConfig config, SerializeFilter[] filters, String dateFormat, int defaultFeatures, SerializerFeature... features) {
        return toJSONBytes(com.alibaba.json.util.IOUtils.UTF8, object, config, filters, dateFormat, defaultFeatures, features);
    }
