...
import static com.alibaba.json.util.TypeUtils.*;

/**
 * @author wenshao[szujobs@hotmail.com]
 */
public class JSONObject extends com.alibaba.json.JSON implements Map<String, Object>, Cloneable, Serializable, InvocationHandler {
    ...
    public JSONObject getJSONObject(String key) {
        ...
        if (value instanceof String) {
            return com.alibaba.json.JSON.parseObject((String) value);
        }
    ...
    public JSONArray getJSONArray(String key) {
        ...
        if (value instanceof String) {
            return (JSONArray) com.alibaba.json.JSON.parse((String) value);
        }
    ...
    public <T> T toJavaObject(Class<T> clazz) {
        if (clazz == Map.class || clazz == JSONObject.class || clazz == com.alibaba.json.JSON.class) {
            return (T) this;
        }

        if (clazz == Object.class && !containsKey(com.alibaba.json.JSON.DEFAULT_TYPE_KEY)) {
            return (T) this;
        }
