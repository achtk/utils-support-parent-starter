...
import static com.alibaba.json.JSONStreamContext.*;

public class JSONReader implements Closeable {

    private final DefaultJSONParser parser;
    private com.alibaba.json.JSONStreamContext context;
    private transient com.alibaba.json.JSONStreamContext lastContext;
    ...
    public void startObject() {
        if (context == null) {
            context = new com.alibaba.json.JSONStreamContext(null, com.alibaba.json.JSONStreamContext.StartObject);
        } else {
            startStructure();
            if (lastContext != null
                    && lastContext.parent == context) {
                context = lastContext;
                if (context.state != com.alibaba.json.JSONStreamContext.StartObject) {
                    context.state = com.alibaba.json.JSONStreamContext.StartObject;
                }
            } else {
                context = new com.alibaba.json.JSONStreamContext(context, com.alibaba.json.JSONStreamContext.StartObject);
            }
        }
    ...
    public void startArray() {
        if (context == null) {
            context = new com.alibaba.json.JSONStreamContext(null, StartArray);
        } else {
            startStructure();

            context = new com.alibaba.json.JSONStreamContext(context, StartArray);
        }
    ...
    public String readString() {
        ...
        if (context == null) {
            ...
            if (context.state == com.alibaba.json.JSONStreamContext.StartObject && lexer.token() == JSONToken.IDENTIFIER) {
