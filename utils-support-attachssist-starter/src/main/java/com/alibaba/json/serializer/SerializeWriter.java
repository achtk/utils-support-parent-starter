...
import com.alibaba.json.util.RyuDouble;
import com.alibaba.json.util.RyuFloat;
...
public final class SerializeWriter extends Writer {
    ...
    final static int nonDirectFeatures = 0 //
            | com.alibaba.json.serializer.SerializerFeature.UseSingleQuotes.mask //
            | com.alibaba.json.serializer.SerializerFeature.BrowserCompatible.mask //
            | com.alibaba.json.serializer.SerializerFeature.PrettyFormat.mask //
            | com.alibaba.json.serializer.SerializerFeature.WriteEnumUsingToString.mask
            | com.alibaba.json.serializer.SerializerFeature.WriteNonStringValueAsString.mask
            | com.alibaba.json.serializer.SerializerFeature.WriteSlashAsSpecial.mask
            | com.alibaba.json.serializer.SerializerFeature.IgnoreErrorGetter.mask
            | com.alibaba.json.serializer.SerializerFeature.WriteClassName.mask
            | com.alibaba.json.serializer.SerializerFeature.NotWriteDefaultValue.mask
            ;
    ...
    static {
        try {
            String prop = com.alibaba.json.util.IOUtils.getStringProperty("fastjson.serializer_buffer_threshold");
    ...
    public SerializeWriter(Writer writer){
        this(writer, JSON.DEFAULT_GENERATE_FEATURE, com.alibaba.json.serializer.SerializerFeature.EMPTY);
    }

    public SerializeWriter(com.alibaba.json.serializer.SerializerFeature... features) {
        this(null, features);
    }

    public SerializeWriter(Writer writer, com.alibaba.json.serializer.SerializerFeature... features) {
     ...
     * @since 1.2.9
     */
    public SerializeWriter(Writer writer, int defaultFeatures, com.alibaba.json.serializer.SerializerFeature... features) {
        this.writer = writer;
    ...
    public void setMaxBufSize(int maxBufSize) {
        if (maxBufSize < this.buf.length) {
            throw new com.alibaba.json.JSONException("must > " + buf.length);
        }

        this.maxBufSize = maxBufSize;
    }

    public void config(com.alibaba.json.serializer.SerializerFeature feature, boolean state) {
        if (state) {
            features |= feature.getMask();
            // 由于枚举序列化特性WriteEnumUsingToString和WriteEnumUsingName不能共存，需要检查
            if (feature == com.alibaba.json.serializer.SerializerFeature.WriteEnumUsingToString) {
                features &= ~com.alibaba.json.serializer.SerializerFeature.WriteEnumUsingName.getMask();
            } else if (feature == com.alibaba.json.serializer.SerializerFeature.WriteEnumUsingName) {
    ...
    protected void computeFeatures() {
        quoteFieldNames = (this.features & com.alibaba.json.serializer.SerializerFeature.QuoteFieldNames.mask) != 0;
        useSingleQuotes = (this.features & com.alibaba.json.serializer.SerializerFeature.UseSingleQuotes.mask) != 0;
        sortField = (this.features & com.alibaba.json.serializer.SerializerFeature.SortField.mask) != 0;
        disableCircularReferenceDetect = (this.features & com.alibaba.json.serializer.SerializerFeature.DisableCircularReferenceDetect.mask) != 0;
        beanToArray = (this.features & com.alibaba.json.serializer.SerializerFeature.BeanToArray.mask) != 0;
        writeNonStringValueAsString = (this.features & com.alibaba.json.serializer.SerializerFeature.WriteNonStringValueAsString.mask) != 0;
        notWriteDefaultValue = (this.features & com.alibaba.json.serializer.SerializerFeature.NotWriteDefaultValue.mask) != 0;
        writeEnumUsingName = (this.features & com.alibaba.json.serializer.SerializerFeature.WriteEnumUsingName.mask) != 0;
        writeEnumUsingToString = (this.features & com.alibaba.json.serializer.SerializerFeature.WriteEnumUsingToString.mask) != 0;
        ...
        browserSecure = (this.features & com.alibaba.json.serializer.SerializerFeature.BrowserSecure.mask) != 0;
...
//        S2 = s;
        sepcialBits = browserSecure
                ? S2
                : (features & com.alibaba.json.serializer.SerializerFeature.WriteSlashAsSpecial.mask) != 0 ? S1 : S0;
    }
    ...
    public boolean isEnabled(com.alibaba.json.serializer.SerializerFeature feature) {
    ...
    public void expandCapacity(int minimumCapacity) {
        if (maxBufSize != -1 && minimumCapacity >= maxBufSize) {
            throw new com.alibaba.json.JSONException("serialize exceeded MAX_OUTPUT_LENGTH=" + maxBufSize + ", minimumCapacity=" + minimumCapacity);
        }
    ...
    public int writeToEx(OutputStream out, Charset charset) throws IOException {
        ...
        if (charset == com.alibaba.json.util.IOUtils.UTF8) {
    ...
    public byte[] toBytes(String charsetName) {
        return toBytes(charsetName == null || "UTF-8".equals(charsetName) //
                ? com.alibaba.json.util.IOUtils.UTF8 //
    ...
    private int encodeToUTF8(OutputStream out) throws IOException {
        ...
        int position = com.alibaba.json.util.IOUtils.encodeUTF8(buf, 0, count, bytes);
    ...
    public void writeInt(int i) {
        ...
        int size = (i < 0) ? com.alibaba.json.util.IOUtils.stringSize(-i) + 1 : com.alibaba.json.util.IOUtils.stringSize(i);
        ...
        if (newcount > buf.length) {
            if (writer == null) {
                ...
                com.alibaba.json.util.IOUtils.getChars(i, size, chars);
                write(chars, 0, chars.length);
                return;
            }
        }

        com.alibaba.json.util.IOUtils.getChars(i, newcount, buf);

        count = newcount;
    }

    public void writeByteArray(byte[] bytes) {
        if (isEnabled(com.alibaba.json.serializer.SerializerFeature.WriteClassName.mask)) {
            writeHex(bytes);
            return;
        }
        ...
        final char[] CA = com.alibaba.json.util.IOUtils.CA;
        ...
        if (value != value || value == Float.POSITIVE_INFINITY || value == Float.NEGATIVE_INFINITY) {
            ...
            if (newcount > buf.length) {
                if (writer == null) {
                    ...
                    String str = com.alibaba.json.util.RyuFloat.toString(value);
                    write(str, 0, str.length());

                    if (checkWriteClassName && isEnabled(com.alibaba.json.serializer.SerializerFeature.WriteClassName)) {
                        write('F');
                    }
                    return;
                }
    ...
    public void writeDouble(double value, boolean checkWriteClassName) {
        ...
        if (newcount > buf.length) {
            if (writer == null) {
                ...
                String str = com.alibaba.json.util.RyuDouble.toString(value);
                write(str, 0, str.length());
    ...
    public void writeEnum(Enum<?> value) {
        ...
        if (strVal != null) {
            char quote = isEnabled(com.alibaba.json.serializer.SerializerFeature.UseSingleQuotes) ? '\'' : '"';
            write(quote);
            write(strVal);
            write(quote);
        } else {
    ...
    public void writeLong(long i) {
        boolean needQuotationMark = isEnabled(com.alibaba.json.serializer.SerializerFeature.BrowserCompatible) //
                && (!isEnabled(com.alibaba.json.serializer.SerializerFeature.WriteClassName)) //
        ...
        if (needQuotationMark) {
            buf[count] = '"';
            com.alibaba.json.util.IOUtils.getChars(i, newcount - 1, buf);
            buf[newcount - 1] = '"';
        } else {
            com.alibaba.json.util.IOUtils.getChars(i, newcount, buf);
        }
    ...
    public void writeNull(com.alibaba.json.serializer.SerializerFeature feature) {
    ...
    public void writeNull(int beanFeatures , int feature) {
        ...
        if ((beanFeatures & com.alibaba.json.serializer.SerializerFeature.WriteMapNullValue.mask) != 0
                && (beanFeatures & ~com.alibaba.json.serializer.SerializerFeature.WriteMapNullValue.mask
                & com.alibaba.json.serializer.SerializerFeature.WRITE_MAP_NULL_FEATURES) == 0) {
            writeNull();
            return;
        }

        if (feature == com.alibaba.json.serializer.SerializerFeature.WriteNullListAsEmpty.mask) {
            write("[]");
        } else if (feature == com.alibaba.json.serializer.SerializerFeature.WriteNullStringAsEmpty.mask) {
            writeString("");
        } else if (feature == com.alibaba.json.serializer.SerializerFeature.WriteNullBooleanAsFalse.mask) {
            write("false");
        } else if (feature == com.alibaba.json.serializer.SerializerFeature.WriteNullNumberAsZero.mask) {
            write('0');
        } else {
            writeNull();
        }
        ...
        if (newcount > buf.length) {
            if (writer != null) {
                ...
                for (int i = 0; i < text.length(); ++i) {
                    ...
                    if (isEnabled(com.alibaba.json.serializer.SerializerFeature.BrowserSecure)) {
                        if (ch == '(' || ch == ')' || ch == '<' || ch == '>') {
                            write('\\');
                            write('u');
                            write(com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 12) & 15]);
                            write(com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 8) & 15]);
                            write(com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 4) & 15]);
                            write(com.alibaba.json.util.IOUtils.DIGITS[ch & 15]);
                            continue;
                        }
                    }

                    if (isEnabled(com.alibaba.json.serializer.SerializerFeature.BrowserCompatible)) {
                        if (ch == '\b' //
                                || ch == '\f' //
                                || ch == '\n' //
                                || ch == '\r' //
                                ...
                                || ch == '\\') {
                            write('\\');
                            write(com.alibaba.json.util.IOUtils.replaceChars[(int) ch]);
                            continue;
                        }
                        ...
                        if (ch < 32) {
                            ...
                            write('0');
                            write('0');
                            write(com.alibaba.json.util.IOUtils.ASCII_CHARS[ch * 2]);
                            write(com.alibaba.json.util.IOUtils.ASCII_CHARS[ch * 2 + 1]);
                            continue;
                        }
                        ...
                        if (ch < com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes.length
                                && com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes[ch] != 0 //
                                || (ch == '/' && isEnabled(com.alibaba.json.serializer.SerializerFeature.WriteSlashAsSpecial))) {
                            write('\\');
                            if (com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes[ch] == 4) {
                                write('u');
                                write(com.alibaba.json.util.IOUtils.DIGITS[ch >>> 12 & 15]);
                                write(com.alibaba.json.util.IOUtils.DIGITS[ch >>> 8 & 15]);
                                write(com.alibaba.json.util.IOUtils.DIGITS[ch >>> 4 & 15]);
                                ...
                                write(com.alibaba.json.util.IOUtils.replaceChars[ch]);
                            }
                            continue;
                        }
                    }
        ...
        if (isEnabled(com.alibaba.json.serializer.SerializerFeature.BrowserCompatible)) {
            ...
            for (int i = lastSpecialIndex; i >= start; --i) {
                ...
                if (ch == '\b' //
                    ...
                    buf[i] = '\\';
                    buf[i + 1] = com.alibaba.json.util.IOUtils.replaceChars[(int) ch];
                    end += 1;
                    continue;
                }
                ...
                if (ch < 32) {
                    ...
                    buf[i + 2] = '0';
                    buf[i + 3] = '0';
                    buf[i + 4] = com.alibaba.json.util.IOUtils.ASCII_CHARS[ch * 2];
                    buf[i + 5] = com.alibaba.json.util.IOUtils.ASCII_CHARS[ch * 2 + 1];
                    end += 5;
                    continue;
                }
                ...
                if (ch >= 127) {
                    ...
                    buf[i] = '\\';
                    buf[i + 1] = 'u';
                    buf[i + 2] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 12) & 15];
                    buf[i + 3] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 8) & 15];
                    buf[i + 4] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 4) & 15];
                    buf[i + 5] = com.alibaba.json.util.IOUtils.DIGITS[ch & 15];
                    end += 5;
                }
            }
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (special) {
                ...
                if (ch == '('
                        ...
                        || ch == '<'
                        || ch == '>'
                        || (ch < com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes.length //
                        && com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes[ch] == 4) //
                ) {
                    newcount += 4;
                }
        ...
        if (specialCount > 0) {
            ...
            if (specialCount == 1) {
                if (lastSpecial == '\u2028') {
                    ...
                    buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 12) & 15];
                    buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 8) & 15];
                    buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 4) & 15];
                    buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.DIGITS[ch & 15];
                } else {
                    final char ch = lastSpecial;
                    if (ch < com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes.length //
                            && com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes[ch] == 4) {
                        ...
                        buf[bufIndex++] = '\\';
                        buf[bufIndex++] = 'u';
                        buf[bufIndex++] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 12) & 15];
                        buf[bufIndex++] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 8) & 15];
                        buf[bufIndex++] = com.alibaba.json.util.IOUtils.DIGITS[(ch >>> 4) & 15];
                        buf[bufIndex++] = com.alibaba.json.util.IOUtils.DIGITS[ch & 15];
                    } else {
                        int srcPos = lastSpecialIndex + 1;
                        ...
                        System.arraycopy(buf, srcPos, buf, destPos, LengthOfCopy);
                        buf[lastSpecialIndex] = '\\';
                        buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.replaceChars[(int) ch];
                    }
                }
                ...
                for (int i = textIndex; i < text.length(); ++i) {
                    ...
                    } else if (ch < com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes.length //
                            && com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes[ch] != 0 //
                            || (ch == '/' && isEnabled(com.alibaba.json.serializer.SerializerFeature.WriteSlashAsSpecial))) {
                        buf[bufIndex++] = '\\';
                        if (com.alibaba.json.util.IOUtils.specicalFlags_doubleQuotes[ch] == 4) {
                            ...
                            buf[bufIndex++] = com.alibaba.json.util.IOUtils.replaceChars[(int) ch];
                            end++;
                        }
                    } else {
                        if (ch == '\u2028' || ch == '\u2029') {
...
//        text.getChars(0, len, buf, start);
    ...
    public void writeFieldValue(char seperator, String name, int value) {
        ...
        int intSize = (value < 0) ? com.alibaba.json.util.IOUtils.stringSize(-value) + 1 : com.alibaba.json.util.IOUtils.stringSize(value);
        ...
        com.alibaba.json.util.IOUtils.getChars(value, count, buf);
    }

    public void writeFieldValue(char seperator, String name, long value) {
        if (value == Long.MIN_VALUE
                || !quoteFieldNames
                || isEnabled(com.alibaba.json.serializer.SerializerFeature.BrowserCompatible.mask)
        ) {
            write(seperator);
            writeFieldName(name);
            writeLong(value);
    ...
    public void writeFieldValue(char seperator, String name, BigDecimal value) {
        ...
        if (value == null) {
            ...
            write(isEnabled(com.alibaba.json.serializer.SerializerFeature.WriteBigDecimalAsPlain) && scale >= -100 && scale < 100
                    ? value.toPlainString()
                    : value.toString()
            );
        }
    ...
    protected void writeStringWithSingleQuote(String text) {
        ...
        if (specialCount == 1) {
            ...
            buf[lastSpecialIndex] = '\\';
            buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.replaceChars[(int) lastSpecial];
        } else if (specialCount > 1) {
            System.arraycopy(buf, lastSpecialIndex + 1, buf, lastSpecialIndex + 2, end - lastSpecialIndex - 1);
            buf[lastSpecialIndex] = '\\';
            buf[++lastSpecialIndex] = com.alibaba.json.util.IOUtils.replaceChars[(int) lastSpecial];
...
//        text.getChars(0, len, buf, start);
    ...
    private void writeKeyWithSingleQuoteIfHasSpecial(String text) {
        final byte[] specicalFlags_singleQuotes = com.alibaba.json.util.IOUtils.specicalFlags_singleQuotes;
        ...
        for (int i = start; i < end; ++i) {
            ...
            if (ch < specicalFlags_singleQuotes.length && specicalFlags_singleQuotes[ch] != 0) {
                if (!hasSpecial) {
                    ...
                    buf[start] = '\'';
                    buf[++i] = '\\';
                    buf[++i] = com.alibaba.json.util.IOUtils.replaceChars[(int) ch];
                    end += 2;
                    buf[count - 2] = '\'';
