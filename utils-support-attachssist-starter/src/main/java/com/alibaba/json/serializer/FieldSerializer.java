...
import com.alibaba.json.serializer.ContextObjectSerializer;
import com.alibaba.json.serializer.DoubleSerializer;
import com.alibaba.json.serializer.FloatCodec;
...
public class FieldSerializer implements Comparable<FieldSerializer> {
    ...
    public final com.alibaba.json.util.FieldInfo fieldInfo;
    ...
    protected com.alibaba.json.serializer.BeanContext fieldContext;
    ...
    public void writePrefix(com.alibaba.json.serializer.JSONSerializer serializer) throws IOException {
    ...
    public void writeValue(JSONSerializer serializer, Object propertyValue) throws Exception {
            ...
            if (fieldAnnotation != null && fieldAnnotation.serializeUsing() != Void.class) {
                ...
                if (format != null) {
                    if (runtimeFieldClass == double.class || runtimeFieldClass == Double.class) {
                        fieldSerializer = new com.alibaba.json.serializer.DoubleSerializer(format);
                    } else if (runtimeFieldClass == float.class || runtimeFieldClass == Float.class) {
                        fieldSerializer = new com.alibaba.json.serializer.FloatCodec(format);
                    }
                }
        ...
        if (format != null && !(valueSerializer instanceof DoubleSerializer || valueSerializer instanceof FloatCodec)) {
            if (valueSerializer instanceof com.alibaba.json.serializer.ContextObjectSerializer) {
