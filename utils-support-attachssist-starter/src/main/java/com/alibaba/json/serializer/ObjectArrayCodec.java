...
public class ObjectArrayCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public final void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType, int features)
        ...
        if (object == null) {
            out.writeNull(com.alibaba.json.serializer.SerializerFeature.WriteNullListAsEmpty);
            return;
        }
    ...
    private <T> T toObjectArray(DefaultJSONParser parser, Class<?> componentType, com.alibaba.json.JSONArray array) {
        if (array == null) {
            return null;
        }
        ...
        for (int i = 0; i < size; ++i) {
            ...
            if (componentType.isArray()) {
                ...
                if (componentType.isInstance(value)) {
                    ...
                    element = toObjectArray(parser, componentType, (com.alibaba.json.JSONArray) value);
                }

                Array.set(objArray, i, element);
            } else {
                Object element = null;
                if (value instanceof com.alibaba.json.JSONArray) {
                    boolean contains = false;
                    com.alibaba.json.JSONArray valueArray = (JSONArray) value;
