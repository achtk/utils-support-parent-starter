...
public class AwtCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    public void write(JSONSerializer serializer, Object object, Object fieldName, Type fieldType,
        ...
        if (object instanceof Point) {
            ...
            throw new com.alibaba.json.JSONException("not support awt class : " + object.getClass().getName());
        }
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
        ...
        if (type == Point.class) {
            ...
            throw new com.alibaba.json.JSONException("not support awt class : " + type);
        }
    ...
    protected Font parseFont(DefaultJSONParser parser) {
        ...
        for (;;) {
            ...
            if (key.equalsIgnoreCase("name")) {
                ...
                throw new com.alibaba.json.JSONException("syntax error, " + key);
            }
