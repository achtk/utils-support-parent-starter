        ...
        if (interfaces.length == 1 && interfaces[0].isAnnotation()) {
            ...
            if (sun_AnnotationType == null && !sun_AnnotationType_error) {
                try {
                    ...
                    throw new com.alibaba.json.JSONException("not support Type Annotation.", ex);
                }
            }

            if (sun_AnnotationType == null) {
                throw new com.alibaba.json.JSONException("not support Type Annotation.");
            }
            ...
            com.alibaba.json.JSONObject json = new JSONObject(members.size());
