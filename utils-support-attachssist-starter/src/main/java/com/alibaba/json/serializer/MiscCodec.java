...
public class MiscCodec implements ObjectSerializer, ObjectDeserializer {
    ...
    private static String toString(org.w3c.dom.Node node) {
        try {
            ...
            throw new com.alibaba.json.JSONException("xml node to string error", e);
        }
    }

    public void write(com.alibaba.json.serializer.JSONSerializer serializer, Object object, Object fieldName, Type fieldType,
        ...
        if (objClass == SimpleDateFormat.class) {
            ...
            if (out.isEnabled(SerializerFeature.WriteClassName)) {
                if (object.getClass() != fieldType) {
                    out.write('{');
                    out.writeFieldName(com.alibaba.json.JSON.DEFAULT_TYPE_KEY);
        ...
        } else if (object instanceof com.alibaba.json.JSONStreamAware) {
            com.alibaba.json.JSONStreamAware aware = (com.alibaba.json.JSONStreamAware) object;
            ...
            throw new com.alibaba.json.JSONException("not support class : " + objClass);
        }
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type clazz, Object fieldName) {
            ...
            for (;;) {
                ...
                if (key.equals("address")) {
                    ...
                    if (lexer.token() != JSONToken.LITERAL_INT) {
                        throw new com.alibaba.json.JSONException("port is not int");
                    }
                    port = lexer.intValue();
                    lexer.nextToken();
                } else {
        ...
        if (objVal == null) {
            ...
            if (objVal instanceof com.alibaba.json.JSONObject) {
                com.alibaba.json.JSONObject jsonObject = (com.alibaba.json.JSONObject) objVal;
            ...
            throw new com.alibaba.json.JSONException("expect string");
        }
        ...
        if (clazz == URL.class) {
            try {
                ...
                throw new com.alibaba.json.JSONException("create url error", e);
            }
        }
        ...
        if (clazz == InetAddress.class || clazz == Inet4Address.class || clazz == Inet6Address.class) {
            try {
                ...
                throw new com.alibaba.json.JSONException("deserialize inet adress error", e);
            }
        }

        if (clazz == File.class) {
            if (strVal.indexOf("..") >= 0 && !FILE_RELATIVE_PATH_SUPPORT) {
                throw new com.alibaba.json.JSONException("file relative path not support.");
            }
        ...
        if (clazz == com.alibaba.json.JSONPath.class) {
            return (T) new com.alibaba.json.JSONPath(strVal);
        }
        ...
        if (clazz instanceof Class) {
            ...
            if (className.equals("java.nio.file.Path")) {
                try {
                    ...
                    throw new com.alibaba.json.JSONException("Path deserialize erorr");
                } catch (NoSuchMethodException ex) {
                    method_paths_get_error = true;
                } catch (IllegalAccessException ex) {
                    throw new com.alibaba.json.JSONException("Path deserialize erorr", ex);
                } catch (InvocationTargetException ex) {
                    throw new com.alibaba.json.JSONException("Path deserialize erorr", ex);
                }
            }

            throw new com.alibaba.json.JSONException("MiscCodec not support " + className);
        }
