...
public class JavaBeanSerializer extends SerializeFilterable implements ObjectSerializer {
    // serializers
    protected final com.alibaba.json.serializer.FieldSerializer[] getters;
    protected final com.alibaba.json.serializer.FieldSerializer[] sortedGetters;
    ...
    public JavaBeanSerializer(SerializeBeanInfo beanInfo) {
        ...
        sortedGetters = new com.alibaba.json.serializer.FieldSerializer[beanInfo.sortedFields.length];
        for (int i = 0; i < sortedGetters.length; ++i) {
            sortedGetters[i] = new com.alibaba.json.serializer.FieldSerializer(beanInfo.beanType, beanInfo.sortedFields[i]);
        }
        
        if (beanInfo.fields == beanInfo.sortedFields) {
            getters = sortedGetters;
        } else {
            getters = new com.alibaba.json.serializer.FieldSerializer[beanInfo.fields.length];
            boolean hashNotMatch = false;
            for (int i = 0; i < getters.length; ++i) {
                com.alibaba.json.serializer.FieldSerializer fieldSerializer = getFieldSerializer(beanInfo.fields[i].name);
    ...
    public void writeDirectNonContext(com.alibaba.json.serializer.JSONSerializer serializer, //
                                      Object object, //
                                      Object fieldName, //
                                      Type fieldType, //
    ...
    public void writeAsArray(com.alibaba.json.serializer.JSONSerializer serializer, //
                             Object object, //
                             Object fieldName, //
                             Type fieldType, //
                             int features) throws IOException {
    ...
    public void writeAsArrayNonContext(com.alibaba.json.serializer.JSONSerializer serializer, //
                                       Object object, //
                                       Object fieldName, //
                                       Type fieldType, //
                                       int features) throws IOException {
    ...
    public void writeNoneASM(com.alibaba.json.serializer.JSONSerializer serializer, //
                             Object object, //
                             Object fieldName, //
                             Type fieldType, //
                             int features) throws IOException {
    ...
    protected void write(com.alibaba.json.serializer.JSONSerializer serializer, //
                         Object object, //
                         Object fieldName, //
                         Type fieldType, //
                         int features,
        ...
        final com.alibaba.json.serializer.FieldSerializer[] getters;
        ...
        com.alibaba.json.serializer.FieldSerializer errorFieldSerializer = null;
        try {
            ...
            for (int i = 0; i < getters.length; ++i) {
                com.alibaba.json.serializer.FieldSerializer fieldSerializer = getters[i];

                Field field = fieldSerializer.fieldInfo.field;
                com.alibaba.json.util.FieldInfo fieldInfo = fieldSerializer.fieldInfo;
            ...
            String errorMessage = "write javaBean error, fastjson version " + com.alibaba.json.JSON.VERSION;
            if (object != null) {
            ...
            if (fieldName != null) {
                ...
                com.alibaba.json.util.FieldInfo fieldInfo = errorFieldSerializer.fieldInfo;
            ...
            throw new com.alibaba.json.JSONException(errorMessage, cause);
        } finally {
            serializer.context = parent;
        }
    }

    protected void writeClassName(com.alibaba.json.serializer.JSONSerializer serializer, String typeKey, Object object) {
        if (typeKey == null) {
    ...
    public boolean writeReference(com.alibaba.json.serializer.JSONSerializer serializer, Object object, int fieldFeatures) {
    ...
    protected boolean isWriteAsArray(com.alibaba.json.serializer.JSONSerializer serializer) {
        return isWriteAsArray(serializer, 0);
    }

    protected boolean isWriteAsArray(com.alibaba.json.serializer.JSONSerializer serializer, int fieldFeatrues) {
    ...
    public Object getFieldValue(Object object, String key) {
        com.alibaba.json.serializer.FieldSerializer fieldDeser = getFieldSerializer(key);
        if (fieldDeser == null) {
            throw new com.alibaba.json.JSONException("field not found. " + key);
        }
        
        try {
            return fieldDeser.getPropertyValue(object);
        } catch (InvocationTargetException ex) {
            throw new com.alibaba.json.JSONException("getFieldValue error." + key, ex);
    ...
    public Object getFieldValue(Object object, String key, long keyHash, boolean throwFieldNotFoundException) {
        com.alibaba.json.serializer.FieldSerializer fieldDeser = getFieldSerializer(keyHash);
        if (fieldDeser == null) {
    ...
    public com.alibaba.json.serializer.FieldSerializer getFieldSerializer(String key) {
        if (key == null) {
            return null;
        }
    ...
    public com.alibaba.json.serializer.FieldSerializer getFieldSerializer(long hash) {
        com.alibaba.json.PropertyNamingStrategy[] namingStrategies = null;
        if (this.hashArray == null) {
            namingStrategies = com.alibaba.json.PropertyNamingStrategy.values();
    ...
    public List<Object> getFieldValues(Object object) throws Exception {
        ...
        for (com.alibaba.json.serializer.FieldSerializer getter : sortedGetters) {
    ...
    protected char writeBefore(com.alibaba.json.serializer.JSONSerializer jsonBeanDeser, //
                               Object object, char seperator) {

        if (jsonBeanDeser.beforeFilters != null) {
            for (com.alibaba.json.serializer.BeforeFilter beforeFilter : jsonBeanDeser.beforeFilters) {
    ...
    protected char writeAfter(com.alibaba.json.serializer.JSONSerializer jsonBeanDeser, //
                              Object object, char seperator) {
        if (jsonBeanDeser.afterFilters != null) {
            for (com.alibaba.json.serializer.AfterFilter afterFilter : jsonBeanDeser.afterFilters) {
    ...
    protected boolean applyLabel(JSONSerializer jsonBeanDeser, String label) {
        if (jsonBeanDeser.labelFilters != null) {
            for (com.alibaba.json.serializer.LabelFilter propertyFilter : jsonBeanDeser.labelFilters) {
