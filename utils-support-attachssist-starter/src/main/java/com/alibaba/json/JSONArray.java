 ...
 */
public class JSONArray extends com.alibaba.json.JSON implements List<Object>, Cloneable, RandomAccess, Serializable {
    ...
    public com.alibaba.json.JSONObject getJSONObject(int index) {
        Object value = list.get(index);

        if (value instanceof com.alibaba.json.JSONObject) {
            return (com.alibaba.json.JSONObject) value;
        }

        if (value instanceof Map) {
            return new com.alibaba.json.JSONObject((Map) value);
        }
    ...
    public <T> T getObject(int index, Type type) {
        ...
        if (type instanceof Class) {
            ...
            String json = com.alibaba.json.JSON.toJSONString(obj);
