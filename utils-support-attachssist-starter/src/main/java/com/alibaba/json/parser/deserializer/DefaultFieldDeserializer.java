...
public class DefaultFieldDeserializer extends FieldDeserializer {
    ...
    public DefaultFieldDeserializer(ParserConfig config, Class<?> clazz, com.alibaba.json.util.FieldInfo fieldInfo) {
        ...
        if (fieldValueDeserilizer == null) {
            ...
            if (annotation != null && annotation.deserializeUsing() != Void.class) {
                ...
                try {
                    ...
                    throw new com.alibaba.json.JSONException("create deserializeUsing ObjectDeserializer error", ex);
                }
            } else {
    ...
    public void parseField(DefaultJSONParser parser, Object object, Type objectType, Map<String, Object> fieldValues) {
        ...
        if (value instanceof byte[]
            ...
            try {
                ...
                throw new com.alibaba.json.JSONException("unzip bytes error.", ex);
            }
        }
