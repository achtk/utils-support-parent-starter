...
public abstract class JSONLexerBase implements JSONLexer, Closeable {
    ...
    protected TimeZone timeZone = com.alibaba.json.JSON.defaultTimeZone;
    protected Locale locale = com.alibaba.json.JSON.defaultLocale;
        ...
        for (int i = 0; i < chars_len; ++i) {
            ...
            switch (ch) {
                ...
                case 'u':
                    ...
                    break;
                default:
                    throw new com.alibaba.json.JSONException("unclosed.str.lit");
            }
        }
            ...
            switch (ch) {
                case '\'':
                    if (!isEnabled(Feature.AllowSingleQuotes)) {
                        throw new com.alibaba.json.JSONException("Feature.AllowSingleQuotes is false");
                    }
                ...
                default:
                    if (isEOF()) { // JLS
                        if (token == JSONToken.EOF) {
                            throw new com.alibaba.json.JSONException("EOF error");
                        }
    ...
    public final void nextTokenWithChar(char expect) {
        ...
        for (;;) {
            ...
            throw new com.alibaba.json.JSONException("not match " + expect + " - " + ch + ", info : " + this.info());
        }
    }
    ...
    public final Number integerValue() throws NumberFormatException {
        ...
        if (negative) {
            if (i > np + 1) {
                ...
                throw new com.alibaba.json.JSONException("illegal number format : " + numberString());
            }
        } else {
            result = -result;
    ...
    public float floatValue() {
        ...
        if (floatValue == 0 || floatValue == Float.POSITIVE_INFINITY) {
            ...
            if (c0 > '0' && c0 <= '9') {
                throw new com.alibaba.json.JSONException("float overflow : " + strVal);
            }
        }
        return floatValue;
    }
    ...
    protected void skipComment() {
        ...
        if (ch == '/') {
            ...
            throw new com.alibaba.json.JSONException("invalid comment");
        }
    }
    ...
    public final String scanSymbol(final SymbolTable symbolTable, final char quote) {
        ...
        for (;;) {
            ...
            if (chLocal == EOI) {
                throw new com.alibaba.json.JSONException("unclosed.str");
            }
    ...
    public final String scanSymbolUnQuoted(final SymbolTable symbolTable) {
        ...
        final boolean[] firstIdentifierFlags = com.alibaba.json.util.IOUtils.firstIdentifierFlags;
        final char first = ch;

        final boolean firstFlag = ch >= firstIdentifierFlags.length || firstIdentifierFlags[first];
        if (!firstFlag) {
            throw new com.alibaba.json.JSONException("illegal identifier : " + ch //
                    + info());
        }
    ...
    public final void scanString() {
        ...
        for (;;) {
            ...
            if (ch == EOI) {
                ...
                throw new com.alibaba.json.JSONException("unclosed string : " + ch);
            }
                ...
                switch (ch) {
                    ...
                    case 'x':
                        ...
                        boolean hex2 = (x2 >= '0' && x2 <= '9')
                                ...
                                || (x2 >= 'A' && x2 <= 'F');
                        if (!hex1 || !hex2) {
                            throw new com.alibaba.json.JSONException("invalid escape character \\x" + x1 + x2);
                        }
    ...
    public long scanFieldSymbol(char[] fieldName) {
        ...
        for (;;) {
            ...
            hash ^= chLocal;
            hash *= TypeUtils.fnv1a_64_magic_prime;
...
//        }
        ...
        for (;;) {
            ...
            if (chLocal == '"') {
                ...
                throw new com.alibaba.json.JSONException("illega str");
            }
...
//            value = Float.parseFloat(text);
    ...
    public BigDecimal scanFieldDecimal(char[] fieldName) {
        ...
        if (chLocal >= '0' && chLocal <= '9') {
            ...
            if (count > 65535) {
                throw new com.alibaba.json.JSONException("scan decimal overflow");
            }
...
//            value = new BigInteger(chars, )
                if (count > 65535) {
                    throw new com.alibaba.json.JSONException("scanInteger overflow");
                }
    ...
    public java.util.Date scanFieldDate(char[] fieldName) {
        ...
        if (chLocal == '"'){
            ...
            com.alibaba.json.parser.JSONScanner dateLexer = new com.alibaba.json.parser.JSONScanner(stringVal);
            try {
    ...
    public java.util.Date scanDate(char seperator) {
        ...
        if (chLocal == '"'){
            ...
            com.alibaba.json.parser.JSONScanner dateLexer = new JSONScanner(stringVal);
            try {
                if (dateLexer.scanISO8601DateIfMatch(false)) {
                    Calendar calendar = dateLexer.getCalendar();
                    dateVal = calendar.getTime();
    ...
    public final void scanTrue() {
        if (ch != 't') {
            throw new com.alibaba.json.JSONException("error parse true");
        }
        next();
        ...
        if (ch == ' '  ||
            ...
            throw new com.alibaba.json.JSONException("scan true error");
        }
    }

    public final void scanNullOrNew(boolean acceptColon) {
        if (ch != 'n') {
            throw new com.alibaba.json.JSONException("error parse null or new");
        }
        next();
        ...
        if (ch == 'u') {
            next();
            if (ch != 'l') {
                throw new com.alibaba.json.JSONException("error parse null");
            }
            next();
            ...
            if (ch == ' '
                ...
                throw new com.alibaba.json.JSONException("scan null error");
            }
            return;
        }

        if (ch != 'e') {
            throw new com.alibaba.json.JSONException("error parse new");
        }
        next();
        ...
        if (ch == ' '  ||
            ...
            throw new com.alibaba.json.JSONException("scan new error");
        }
    }
    ...
    public final void scanFalse() {
        if (ch != 'f') {
            throw new com.alibaba.json.JSONException("error parse false");
        }
        next();
        ...
        if (ch == ' '  ||
            ...
            throw new com.alibaba.json.JSONException("scan false error");
        }
    }
    ...
    private void scanStringSingleQuote() {
        ...
        for (;;) {
            ...
            if (chLocal == EOI) {
                ...
                throw new com.alibaba.json.JSONException("unclosed single-quote string");
            }
    ...
    public final void scanHex() {
        if (ch != 'x') {
            throw new com.alibaba.json.JSONException("illegal state. " + ch);
        }
        next();
        if (ch != '\'') {
            throw new com.alibaba.json.JSONException("illegal state. " + ch);
    ...
    public final void scanNumber() {
        ...
        if (sp > 65535) {
            throw new com.alibaba.json.JSONException("scanNumber overflow");
        }
