...
public class MapDeserializer extends ContextObjectDeserializer implements com.alibaba.json.parser.deserializer.ObjectDeserializer {
    ...
    public static Map parseMap(DefaultJSONParser parser, Map<String, Object> map, Type valueType, Object fieldName, int features) {
        ...
        if (token != JSONToken.LBRACE) {
            ...
            if (token != JSONToken.LITERAL_STRING) {
                com.alibaba.json.JSONArray array = new JSONArray();
            ...
            for (int i = 0;;++i) {
                ...
                if (key == com.alibaba.json.JSON.DEFAULT_TYPE_KEY
                    ...
                    if (typeName.equals("java.util.HashMap")) {
                        ...
                        } catch (com.alibaba.json.JSONException ex) {
                            // skip
                            clazz = java.util.HashMap.class;
                        }
                    }
    ...
    public static Object parseMap(DefaultJSONParser parser, Map<Object, Object> map, Type keyType, Type valueType,
        ...
        com.alibaba.json.parser.deserializer.ObjectDeserializer keyDeserializer = parser.getConfig().getDeserializer(keyType);
            ...
            for (;;) {
                ...
                if (lexer.token() == JSONToken.LITERAL_STRING //
                    ...
                    if (lexer.token() == JSONToken.LITERAL_STRING) {
                        ...
                        throw new com.alibaba.json.JSONException("illegal ref, " + JSONToken.name(lexer.token()));
                    }
                ...
                if (map.size() == 0 //
                        ...
                        && com.alibaba.json.JSON.DEFAULT_TYPE_KEY.equals(lexer.stringVal()) //
                        && !lexer.isEnabled(Feature.DisableSpecialKeyDetect)) {
                    lexer.nextTokenWithColon(JSONToken.LITERAL_STRING);
                    lexer.nextToken(JSONToken.COMMA);
                    if (lexer.token() == JSONToken.RBRACE) {
                ...
                if (lexer.token() != JSONToken.COLON) {
                    throw new com.alibaba.json.JSONException("syntax error, expect :, actual " + lexer.token());
                }
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName, String format, int features) {
        if (type == com.alibaba.json.JSONObject.class && parser.getFieldTypeResolver() == null) {
    ...
    public Map<Object, Object> createMap(Type type, int featrues) {
        ...
        if (clazz.isInterface()) {
            throw new com.alibaba.json.JSONException("unsupport type " + type);
        }
