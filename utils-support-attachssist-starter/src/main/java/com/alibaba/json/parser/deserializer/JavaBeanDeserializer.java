...
import com.alibaba.json.JSONValidator;
import com.alibaba.json.util.FieldInfo;
import com.alibaba.json.util.JavaBeanInfo;
...
public class JavaBeanDeserializer implements com.alibaba.json.parser.deserializer.ObjectDeserializer {

    public final com.alibaba.json.util.JavaBeanInfo beanInfo;
    ...
    public JavaBeanDeserializer(ParserConfig config, Class<?> clazz, Type type){
        this(config //
                , com.alibaba.json.util.JavaBeanInfo.build(clazz, type, config.propertyNamingStrategy, config.fieldBased, config.compatibleWithJavaBean, config.isJacksonCompatible())
        );
    }

    public JavaBeanDeserializer(ParserConfig config, com.alibaba.json.util.JavaBeanInfo beanInfo) {
        ...
        for (int i = 0, size = beanInfo.sortedFields.length; i < size; ++i) {
            com.alibaba.json.util.FieldInfo fieldInfo = beanInfo.sortedFields[i];
        ...
        for (int i = 0, size = beanInfo.fields.length; i < size; ++i) {
            com.alibaba.json.util.FieldInfo fieldInfo = beanInfo.fields[i];
    ...
    protected static JavaBeanDeserializer getSeeAlso(ParserConfig config, com.alibaba.json.util.JavaBeanInfo beanInfo, String typeName) {
        if (beanInfo.jsonType == null) {
            return null;
        }

        for (Class<?> seeAlsoClass : beanInfo.jsonType.seeAlso()) {
            com.alibaba.json.parser.deserializer.ObjectDeserializer seeAlsoDeser = config.getDeserializer(seeAlsoClass);
...
//        parser.accept(JSONToken.RBRACKET, JSONToken.COMMA);
    ...
    public Object createInstance(DefaultJSONParser parser, Type type) {
        if (type instanceof Class) {
            if (clazz.isInterface()) {
                ...
                final com.alibaba.json.JSONObject obj = new com.alibaba.json.JSONObject();
        ...
        try {
            ...
            if (beanInfo.defaultConstructorParameterSize == 0) {
                ...
                if (context == null || context.object == null) {
                    throw new com.alibaba.json.JSONException("can't create non-static inner class instance.");
                }
            ...
            throw new com.alibaba.json.JSONException("create instance error, class " + clazz.getName(), e);
        }
    ...
    public <T> T deserialzeArrayMapping(DefaultJSONParser parser, Type type, Object fieldName, Object object) {
        ...
        if (lexer.token() != JSONToken.LBRACKET) {
            throw new com.alibaba.json.JSONException("error");
        }

        String typeName = null;
        if ((typeName = lexer.scanTypeName(parser.symbolTable)) != null) {
            com.alibaba.json.parser.deserializer.ObjectDeserializer deserializer = getSeeAlso(parser.getConfig(), this.beanInfo, typeName);
            Class<?> userType = null;
        ...
        for (int i = 0, size = sortedFieldDeserializers.length; i < size; ++i) {
            ...
            if (fieldClass == int.class) {
                ...
                if (ch == '\"' || ch == 'n') {
                    ...
                    com.alibaba.json.parser.deserializer.EnumDeserializer enumDeser = (com.alibaba.json.parser.deserializer.EnumDeserializer) ((com.alibaba.json.parser.deserializer.DefaultFieldDeserializer) fieldDeser).getFieldValueDeserilizer(parser.getConfig());
    ...
    protected Enum<?> scanEnum(JSONLexer lexer, char seperator) {
        throw new com.alibaba.json.JSONException("illegal enum. " + lexer.info());
    }
    ...
    protected <T> T deserialze(DefaultJSONParser parser, //
                               ...
                               int features, //
                               int[] setFlags) {
        if (type == com.alibaba.json.JSON.class || type == JSONObject.class) {
        ...
        try {
            ...
            if (token != JSONToken.LBRACE && token != JSONToken.COMMA) {
                ...
                if (beanInfo.factoryMethod != null && beanInfo.fields.length == 1) {
                    try {
                        com.alibaba.json.util.FieldInfo field = beanInfo.fields[0];
                        ...
                        throw new com.alibaba.json.JSONException(ex.getMessage(), ex);
                    }
                }
                ...
                buf.append(", fastjson-version ").append(com.alibaba.json.JSON.VERSION);

                throw new com.alibaba.json.JSONException(buf.toString());
            }
            ...
            for (int fieldIndex = 0, notMatchCount = 0;; fieldIndex++) {
                ...
                com.alibaba.json.util.FieldInfo fieldInfo = null;
                ...
                if (fieldIndex < sortedFieldDeserializers.length && notMatchCount < 16) {
                    ...
                    if (fieldAnnotation != null && fieldDeserializer instanceof com.alibaba.json.parser.deserializer.DefaultFieldDeserializer) {
                        customDeserializer = ((com.alibaba.json.parser.deserializer.DefaultFieldDeserializer) fieldDeserializer).customDeserilizer;
                    }
                }
                ...
                if (fieldDeserializer != null) {
                    ...
                    if (customDeserializer && lexer.matchField(name_chars)) {
                        ...
                        if (lexer.matchStat > 0) {
                            ...
                            && parser.getConfig().getDeserializer(fieldClass) instanceof com.alibaba.json.parser.deserializer.EnumDeserializer
                            && (fieldAnnotation == null || fieldAnnotation.deserializeUsing() == Void.class)
                            ) {
                        if (fieldDeserializer instanceof com.alibaba.json.parser.deserializer.DefaultFieldDeserializer) {
                            com.alibaba.json.parser.deserializer.ObjectDeserializer fieldValueDeserilizer = ((com.alibaba.json.parser.deserializer.DefaultFieldDeserializer) fieldDeserializer).fieldValueDeserilizer;
                ...
                if (!matchField) {
                    ...
                    if ("$ref" == key && context != null) {
                        ...
                        if (token == JSONToken.LITERAL_STRING) {
                            ...
                            throw new com.alibaba.json.JSONException("illegal ref, " + JSONToken.name(token));
                        }
                    ...
                    if ((typeKey != null && typeKey.equals(key))
                            || com.alibaba.json.JSON.DEFAULT_TYPE_KEY == key) {
                        lexer.nextTokenWithColon(JSONToken.LITERAL_STRING);
                        if (lexer.token() == JSONToken.LITERAL_STRING) {
                            ...
                            com.alibaba.json.parser.deserializer.ObjectDeserializer deserializer = getSeeAlso(config, this.beanInfo, typeName);
                            Class<?> userType = null;
                ...
                if (matchField) {
                    ...
                    if (!match) {
                        ...
                        throw new com.alibaba.json.JSONException("syntax error, unexpect token ':'");
                    }
                }
                ...
                if (lexer.token() == JSONToken.IDENTIFIER || lexer.token() == JSONToken.ERROR) {
                    throw new com.alibaba.json.JSONException("syntax error, unexpect token " + JSONToken.name(lexer.token()));
                }
            }
            ...
            if (object == null) {
                ...
                if (paramNames != null) {
                    ...
                    com.alibaba.json.util.FieldInfo[] fieldInfoList = beanInfo.fields;
                    int size = fieldInfoList.length;
                    params = new Object[size];
                    for (int i = 0; i < size; ++i) {
                        com.alibaba.json.util.FieldInfo fieldInfo = fieldInfoList[i];
                ...
                if (beanInfo.creatorConstructor != null) {
                    ...
                    try {
                        ...
                        throw new com.alibaba.json.JSONException("create instance error, " + paramNames + ", "
                    ...
                    try {
                        ...
                        throw new com.alibaba.json.JSONException("create factory method error, " + beanInfo.factoryMethod.toString(), e);
                    }
                }
            ...
            try {
                ...
                throw new com.alibaba.json.JSONException("build object error", e);
            }
    ...
    protected Enum scanEnum(JSONLexerBase lexer, char[] name_chars, com.alibaba.json.parser.deserializer.ObjectDeserializer fieldValueDeserilizer) {
        com.alibaba.json.parser.deserializer.EnumDeserializer enumDeserializer = null;
        if (fieldValueDeserilizer instanceof com.alibaba.json.parser.deserializer.EnumDeserializer) {
        ...
        if (lexer.matchStat > 0) {
            ...
            if (e == null) {
                ...
                if (lexer.isEnabled(Feature.ErrorOnEnumNotMatch)) {
                    throw new com.alibaba.json.JSONException("not match enum value, " + enumDeserializer.enumClass);
                }
            }
    ...
    public boolean parseField(DefaultJSONParser parser, String key, Object object, Type objectType,
        ...
        if (fieldDeserializer == null
            ...
            if (deserOrField != null) {
                if (deserOrField instanceof FieldDeserializer) {
                    ...
                    com.alibaba.json.util.FieldInfo fieldInfo = new com.alibaba.json.util.FieldInfo(key, field.getDeclaringClass(), field.getType(), field.getGenericType(), field, 0, 0, 0);
                    fieldDeserializer = new com.alibaba.json.parser.deserializer.DefaultFieldDeserializer(parser.getConfig(), clazz, fieldInfo);
        ...
        if (fieldDeserializer == null) {
            ...
            for (int i = 0; i < this.sortedFieldDeserializers.length; i++) {
                ...
                com.alibaba.json.util.FieldInfo fieldInfo = fieldDeser.fieldInfo;
                if (fieldInfo.unwrapped //
                        && fieldDeser instanceof com.alibaba.json.parser.deserializer.DefaultFieldDeserializer) {
                    if (fieldInfo.field != null) {
                        com.alibaba.json.parser.deserializer.DefaultFieldDeserializer defaultFieldDeserializer = (DefaultFieldDeserializer) fieldDeser;
                        com.alibaba.json.parser.deserializer.ObjectDeserializer fieldValueDeser = defaultFieldDeserializer.getFieldValueDeserilizer(parser.getConfig());
                        if (fieldValueDeser instanceof JavaBeanDeserializer) {
                            ...
                            if (unwrappedFieldDeser != null) {
                                ...
                                try {
                                    ...
                                    throw new com.alibaba.json.JSONException("parse unwrapped field error.", e);
                                }
                            }
    ...
    public FieldDeserializer smartMatch(String key, int[] setFlags) {
        ...
        if (fieldDeserializer == null) {
            ...
            if (fieldDeserializer != null) {
                com.alibaba.json.util.FieldInfo fieldInfo = fieldDeserializer.fieldInfo;
    ...
    public Object createInstance(Map<String, Object> map, ParserConfig config) //
        ...
        if (beanInfo.creatorConstructor == null && beanInfo.factoryMethod == null) {
            ...
            for (Map.Entry<String, Object> entry : map.entrySet()) {
                ...
                final com.alibaba.json.util.FieldInfo fieldInfo = fieldDeser.fieldInfo;
        ...
        if (beanInfo.creatorConstructor != null) {
            ...
            if (hasNull && beanInfo.kotlinDefaultConstructor != null) {
                try {
                    ...
                    throw new com.alibaba.json.JSONException("create instance error, "
                            + beanInfo.creatorConstructor.toGenericString(), e);
                }
            } else {
                try {
