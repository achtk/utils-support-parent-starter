...
public class DefaultExtJSONParser extends DefaultJSONParser {
    ...
    public DefaultExtJSONParser(String input) {
        this(input, com.alibaba.json.parser.ParserConfig.getGlobalInstance());
    }

    public DefaultExtJSONParser(String input, com.alibaba.json.parser.ParserConfig mapping) {
        super(input, mapping);
    }

    public DefaultExtJSONParser(String input, com.alibaba.json.parser.ParserConfig mapping, int features) {
