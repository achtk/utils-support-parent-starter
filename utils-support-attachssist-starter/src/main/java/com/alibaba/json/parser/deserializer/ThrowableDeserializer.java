...
public class ThrowableDeserializer extends com.alibaba.json.parser.deserializer.JavaBeanDeserializer {
    ...
    public <T> T deserialze(DefaultJSONParser parser, Type type, Object fieldName) {
        ...
        if (exClass == null) {
            ...
            if (!Throwable.class.isAssignableFrom(exClass)) {
                throw new com.alibaba.json.JSONException("type not match, not Throwable. " + exClass.getName());
            }
        ...
        if (otherValues != null) {
            com.alibaba.json.parser.deserializer.JavaBeanDeserializer exBeanDeser = null;
            ...
            if (exClass != null) {
                if (exClass == clazz) {
                    ...
                    if (exDeser instanceof com.alibaba.json.parser.deserializer.JavaBeanDeserializer) {
