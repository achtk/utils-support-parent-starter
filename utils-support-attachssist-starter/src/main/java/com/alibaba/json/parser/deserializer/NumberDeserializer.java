    ...
    public <T> T deserialze(DefaultJSONParser parser, Type clazz, Object fieldName) {
        ...
        if (lexer.token() == JSONToken.LITERAL_INT) {
            ...
            if (clazz == short.class || clazz == Short.class) {
                if (val > Short.MAX_VALUE || val < Short.MIN_VALUE) {
                    throw new com.alibaba.json.JSONException("short overflow : " + val);
                }
        ...
        if (clazz == double.class || clazz == Double.class) {
            try {
                ...
                throw new com.alibaba.json.JSONException("parseDouble error, field : " + fieldName, ex);
            }
        }
        ...
        if (clazz == short.class || clazz == Short.class) {
            try {
                ...
                throw new com.alibaba.json.JSONException("parseShort error, field : " + fieldName, ex);
            }
        }
