...
public final class JSONReaderScanner extends JSONLexerBase {
    ...
    public JSONReaderScanner(char[] input, int inputLength){
        this(input, inputLength, com.alibaba.json.JSON.DEFAULT_PARSER_FEATURE);
    }
    ...
    public final char charAt(int index) {
        if (index >= bufLength) {
            ...
            if (bp == 0) {
                ...
                if (bufLength == 0) {
                    throw new com.alibaba.json.JSONException("illegal state, textLength is zero");
                }
    ...
    public final char next() {
        ...
        if (index >= bufLength) {
            ...
            if (bufLength == 0) {
                throw new com.alibaba.json.JSONException("illegal stat, textLength is zero");
            }
    ...
    public byte[] bytesValue() {
        ...
        return com.alibaba.json.util.IOUtils.decodeBase64(buf, np + 1, sp);
    }
