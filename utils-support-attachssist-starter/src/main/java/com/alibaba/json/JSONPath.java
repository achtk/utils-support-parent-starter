...
import com.alibaba.json.JSONPathException;
...
public class JSONPath implements JSONAware {
    ...
    public JSONPath(String path, SerializeConfig serializeConfig, ParserConfig parserConfig, boolean ignoreNullValue){
        if (path == null || path.length() == 0) {
            throw new com.alibaba.json.JSONPathException("json-path can not be null or empty");
        }
    ...
    public static JSONPath compile(String path) {
        if (path == null) {
            throw new com.alibaba.json.JSONPathException("jsonpath can not be null");
        }
    ...
    public static Object read(String json, String path) {
        return compile(path)
                .eval(
                        com.alibaba.json.JSON.parse(json)
                );
    }
    ...
    public static <T> T read(String json, String path, Type clazz, ParserConfig parserConfig) {
        return compile(path).eval(com.alibaba.json.JSON.parse(json), clazz, parserConfig);
    }
    ...
    public static Object extract(String json, String path) {
        return extract(json, path, ParserConfig.global, com.alibaba.json.JSON.DEFAULT_PARSER_FEATURE);
    }
    ...
    private static void paths(Map<Object, String> values, Map<String, Object> paths, String parent, Object javaObject, SerializeConfig config) {
        ...
        if (serializer instanceof JavaBeanSerializer) {
            ...
            try {
                ...
                throw new com.alibaba.json.JSONException("toJSON error", e);
            }
            return;
        }
    ...
    public static Object reserveToArray(Object object, String... paths) {
        com.alibaba.json.JSONArray reserved = new JSONArray();
    ...
    public static Object reserveToObject(Object object, String... paths) {
        ...
        com.alibaba.json.JSONObject reserved = new JSONObject(true);
        for (String item : paths) {
            JSONPath path = JSONPath.compile(item);
            path.init();
    ...
    public void patchAdd(Object rootObject, Object value, boolean replace) {
        ...
        for (int i = 0; i < segments.length; ++i) {
            ...
            if (currentObject == null && i != segments.length - 1) {
                if (segment instanceof PropertySegment) {
                    currentObject = new com.alibaba.json.JSONObject();
        ...
        if (result != null && !replace) {
            ...
            if (resultClass.isArray()) {
                ...
                throw new com.alibaba.json.JSONException("unsupported array put operation. " + resultClass);
            }
        } else {
            newResult = value;
        }
    ...
    public void arrayAdd(Object rootObject, Object... values) {
        ...
        if (result == null) {
            throw new com.alibaba.json.JSONPathException("value not found in path " + path);
        }
...
//
            ...
            if (currentObject == null) {
                ...
                if (nextSegment instanceof PropertySegment) {
                    ...
                    if (beanDeserializer != null) {
                        ...
                        newObj = new com.alibaba.json.JSONObject();
                    }
                } else if (nextSegment instanceof ArrayAccessSegment) {
                    newObj = new com.alibaba.json.JSONArray();
                }
    ...
    public boolean setArrayItem(JSONPath path, Object currentObject, int index, Object value) {
        ...
        throw new com.alibaba.json.JSONPathException("unsupported set operation." + clazz);
    }
    ...
    protected Collection<Object> getPropertyValues(final Object currentObject) {
        ...
        if (beanSerializer != null) {
            try {
                ...
                throw new com.alibaba.json.JSONPathException("jsonpath error, path " + path, e);
            }
        }
    ...
    protected Object getPropertyValue(Object currentObject, String propertyName, long propertyNameHash) {
        ...
        if (currentObject instanceof String) {
            try {
                com.alibaba.json.JSONObject object = (com.alibaba.json.JSONObject) com.alibaba.json.JSON.parse((String) currentObject, parserConfig);
        ...
        if (beanSerializer != null) {
            try {
                ...
                throw new com.alibaba.json.JSONPathException("jsonpath error, path " + path + ", segement " + propertyName, e);
            }
        }
        ...
        if (currentObject instanceof List) {
            ...
            for (int i = 0; i < list.size(); ++i) {
                ...
                if (obj == list) {
                    if (fieldValues == null) {
                        fieldValues = new com.alibaba.json.JSONArray(list.size());
                    }
                    fieldValues.add(obj);
                    continue;
                }
        ...
        if (currentObject instanceof Object[]) {
            ...
            List<Object> fieldValues = new com.alibaba.json.JSONArray(array.length);
            ...
            try {
                ...
                if (fieldDeser != null) {
                    try {
                        ...
                        throw new com.alibaba.json.JSONException("getFieldValue error." + propertyName, ex);
    ...
    int evalSize(Object currentObject) {
        ...
        try {
            ...
            throw new com.alibaba.json.JSONPathException("evalSize error : " + path, e);
        }
    }
    ...
    static class JSONPathParser {
                ...
                if (ch == '.' || ch == '/') {
                    ...
                    if (ch == '(') {
                        ...
                        if (ch == ')') {
                            ...
                            throw new com.alibaba.json.JSONPathException("not support jsonpath : " + path);
                        }
            ...
            if (predicateFlag
                ...
                if (op == Operator.BETWEEN || op == Operator.NOT_BETWEEN) {
                    ...
                    if (!"and".equalsIgnoreCase(name)) {
                        throw new com.alibaba.json.JSONPathException(path);
                    }
                ...
                if (op == Operator.IN || op == Operator.NOT_IN) {
                    ...
                    List<Object> valueList = new com.alibaba.json.JSONArray();
                    {
        ...
        String readName() {
            ...
            if (ch != '\\' && !Character.isJavaIdentifierStart(ch)) {
                throw new com.alibaba.json.JSONPathException("illeal jsonpath syntax. " + path);
            }
        ...
        void accept(char expect) {
            ...
            if (ch != expect) {
                throw new com.alibaba.json.JSONPathException("expect '" + expect + ", but '" + ch + "'");
            }
    ...
    static class FloorSegment implements Segment {
        ...
        public Object eval(JSONPath path, Object rootObject, Object currentObject) {
            if (currentObject instanceof com.alibaba.json.JSONArray) {
                com.alibaba.json.JSONArray array = ((com.alibaba.json.JSONArray) ((com.alibaba.json.JSONArray) currentObject).clone());
    ...
    static class PropertySegment implements Segment {
        ...
        public void extract(JSONPath path, DefaultJSONParser parser, Context context) {
            ...
            if (deep && context.object == null) {
                context.object = new com.alibaba.json.JSONArray();
            }
            ...
            if (lexer.token() == JSONToken.LBRACKET) {
                ...
                lexer.nextToken();
                com.alibaba.json.JSONArray array;

                if (deep) {
                    array = (com.alibaba.json.JSONArray) context.object;
                } else {
                    array = new com.alibaba.json.JSONArray();
                }
                for (;;) {
                    switch (lexer.token()) {
                    ...
                    if (lexer.token() == JSONToken.RBRACKET) {
                        ...
                        throw new com.alibaba.json.JSONException("illegal json : " + lexer.info());
                    }
                }
    ...
    static class MultiPropertySegment implements Segment {
        ...
        public void extract(JSONPath path, DefaultJSONParser parser, Context context) {
            ...
            if (context.object == null) {
                context.object = array = new com.alibaba.json.JSONArray();
            } else {
                array = (com.alibaba.json.JSONArray) context.object;
            }
...
//            }
    ...
    static class WildCardSegment implements Segment {
        ...
        public void extract(JSONPath path, DefaultJSONParser parser, Context context) {
            if (context.eval) {
                ...
                if (object instanceof com.alibaba.json.JSONObject) {
                    Collection<Object> values = ((com.alibaba.json.JSONObject) object).values();
                    com.alibaba.json.JSONArray array = new com.alibaba.json.JSONArray(values.size());
                    array.addAll(values);
                    context.object = array;
                    return;
                } else if (object instanceof com.alibaba.json.JSONArray) {
    ...
    static class MultiIndexSegment implements Segment {
        ...
        public Object eval(JSONPath path, Object rootObject, Object currentObject) {
            List<Object> items = new com.alibaba.json.JSONArray(indexes.length);
        ...
        protected PropertyFilter(String propertyName, boolean function) {
            ...
            if (function) {
                if (propertyNameHash == TYPE) {
                    ...
                    throw new com.alibaba.json.JSONPathException("unsupported funciton : " + propertyName);
                }
            }
        }
    ...
    static public class FilterSegment implements Segment {
        ...
        public Object eval(JSONPath path, Object rootObject, Object currentObject) {
            ...
            List<Object> items = new com.alibaba.json.JSONArray();
