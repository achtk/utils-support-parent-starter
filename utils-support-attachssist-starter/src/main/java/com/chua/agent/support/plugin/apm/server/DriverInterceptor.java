 ...
 * @author CH
 */
public class DriverInterceptor implements Interceptor{
    @Override
    ...
    public static Object intercept(
        ...
        try {
            ...
            ServiceAgentPlugin.registerConnection(objects, "image", "resources/images/" + netAddress.getProtocol().replace(":", "") + ".png" );
