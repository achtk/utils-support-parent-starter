...
import com.chua.agent.support.plugin.LogAgentPlugin;
...
public class Listener {
    ...
    private static void registerIntoSlf4jPlugin(Object thisObject, Object args) {
        ...
        if (!"".equals(type) && !type.contains("Banner")) {
            LogAgentPlugin.registerSlf4j(new Object[]{"\u001b[38;5;35m" + type + "\u001b[0;m"});
        }
        LogAgentPlugin.registerSlf4j(new Object[]{args});
    }
