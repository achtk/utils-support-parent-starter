 ...
 * @author CH
 */
public class ZooKeeperInterceptor implements Interceptor {
    @Override
    public DynamicType.Builder<?> transform(DynamicType.Builder<?> builder) {
        return builder.method(ElementMatchers.named("getServerAddresses")).intercept(MethodDelegation.to(ZooKeeperInterceptor.class));
    }
    ...
    public static Object intercept(
        ...
        if(call instanceof List) {
            try {
                ServiceAgentPlugin.registerAddress((List<InetSocketAddress>) call, "image", "resources/images/zookeeper.png");
