...
import com.chua.agent.support.plugin.ExceptionAgentPlugin;
import javassist.*;
...
//            if (className.equals(PrintStream.class.getTypeName().replace(".", "/"))) {
//                return createPrintStream(className, classBeingRedefined, classfileBuffer);
//            }
