...
import static com.chua.agent.support.constant.Constant.DEFAULT_ADDRESS;
import static com.chua.agent.support.constant.Constant.WHITE_ADDRESS;
...
public class HttpUtils {
    ...
    public static boolean isPass(Object request) {
        ...
        String s = getStringValue(WHITE_ADDRESS, DEFAULT_ADDRESS);
