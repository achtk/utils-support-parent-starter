...
import com.chua.agent.support.json.asm.*;
import com.chua.agent.support.json.parser.*;
import com.chua.agent.support.json.util.*;
...
public class ASMDeserializerFactory implements Opcodes {
    ...
    final static String DefaultJSONParser = ASMUtils.type(com.chua.agent.support.json.parser.DefaultJSONParser.class);
    final static String JSONLexerBase = ASMUtils.type(com.chua.agent.support.json.parser.JSONLexerBase.class);
    ...
    private void _deserialzeArrayMapping(ClassWriter cw, Context context) {
        ...
        mw.visitMethodInsn(INVOKEVIRTUAL, JSONLexerBase, "scanTypeName", "(" + ASMUtils.desc(SymbolTable.class) + ")Ljava/lang/String;");
        ...
        mw.visitFieldInsn(GETFIELD, ASMUtils.type(JavaBeanDeserializer.class), "beanInfo", ASMUtils.desc(JavaBeanInfo.class));
        mw.visitVarInsn(ALOAD, context.var("typeName"));
        mw.visitMethodInsn(INVOKESTATIC, ASMUtils.type(JavaBeanDeserializer.class), "getSeeAlso"
                , "(" + ASMUtils.desc(ParserConfig.class) + ASMUtils.desc(JavaBeanInfo.class) + "Ljava/lang/String;)" + ASMUtils.desc(JavaBeanDeserializer.class));
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == byte.class //
                ...
                mw.visitLdcInsn(com.chua.agent.support.json.parser.JSONLexerBase.VALUE_NULL);
                ...
                mw.visitVarInsn(ALOAD, context.var("lexer"));
                mw.visitLdcInsn(com.chua.agent.support.json.asm.Type.getType(ASMUtils.desc(fieldClass)));
                mw.visitVarInsn(ALOAD, 1);
                mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getSymbolTable", "()" + ASMUtils.desc(SymbolTable.class));
                mw.visitVarInsn(BIPUSH, seperator);
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(ALOAD, 1);
                    mw.visitLdcInsn(com.chua.agent.support.json.asm.Type.getType(ASMUtils.desc(itemClass)));
                    mw.visitVarInsn(ALOAD, 3);
                ...
                if (fieldClass == Date.class) {
                    ...
                    mw.visitTypeInsn(NEW, ASMUtils.type(Date.class));
                    mw.visitInsn(DUP);
                    ...
                    mw.visitMethodInsn(INVOKESPECIAL, ASMUtils.type(Date.class), "<init>", "(J)V");
                    mw.visitVarInsn(ASTORE, context.var_asm(fieldInfo));
...
//                mw.visitInsn(POP);
                ...
                mw.visitMethodInsn(INVOKESPECIAL, //
                        ASMUtils.type(JavaBeanDeserializer.class), //
                        "check", "(" + ASMUtils.desc(JSONLexer.class) + "I)V");
    ...
    private void _deserialze(ClassWriter cw, Context context) {
        ...
        mw.visitLdcInsn(com.chua.agent.support.json.parser.JSONLexerBase.NOT_MATCH);
        ...
        mw.visitVarInsn(ALOAD, context.var("lexer"));
        mw.visitFieldInsn(GETFIELD, JSONLexerBase, "matchStat", "I");
        mw.visitLdcInsn(com.chua.agent.support.json.parser.JSONLexerBase.END);
        ...
        for (int i = 0; i < fieldListSize; ++i) {
            ...
            if (fieldClass == boolean.class) {
                ...
                _getFieldDeser(context, mw, fieldInfo);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "scanEnum"
                        , "(L" + JSONLexerBase + ";[C" + ASMUtils.desc(ObjectDeserializer.class) + ")Ljava/lang/Enum;");
                mw.visitTypeInsn(CHECKCAST, ASMUtils.type(fieldClass)); // cast
                mw.visitVarInsn(ASTORE, context.var_asm(fieldInfo));
...
//                mw.visitLabel(enumNull_);
                ...
                if (itemClass == String.class) {
                    mw.visitLdcInsn(com.chua.agent.support.json.asm.Type.getType(ASMUtils.desc(fieldClass))); // cast
    ...
    private void defineVarLexer(Context context, MethodVisitor mw) {
        mw.visitVarInsn(ALOAD, 1);
        mw.visitFieldInsn(GETFIELD, DefaultJSONParser, "lexer", ASMUtils.desc(JSONLexer.class));
    ...
    private void _deserialze_list_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.chua.agent.support.json.asm.Type.getType(ASMUtils.desc(itemType)));
        mw.visitInsn(ICONST_0);
        mw.visitMethodInsn(INVOKESTATIC, "java/lang/Integer", "valueOf", "(I)Ljava/lang/Integer;");
    ...
    private void _deserialze_obj(Context context, MethodVisitor mw, Label reset_, FieldInfo fieldInfo,
        ...
        mw.visitLdcInsn(com.chua.agent.support.json.parser.DefaultJSONParser.NeedToResolve);
        mw.visitJumpInsn(IF_ICMPNE, _end_if);

        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getLastResolveTask", "()" + ASMUtils.desc(com.chua.agent.support.json.parser.DefaultJSONParser.ResolveTask.class));
        mw.visitVarInsn(ASTORE, context.var("resolveTask"));

        mw.visitVarInsn(ALOAD, context.var("resolveTask"));
        mw.visitVarInsn(ALOAD, 1);
        mw.visitMethodInsn(INVOKEVIRTUAL, DefaultJSONParser, "getContext", "()" + ASMUtils.desc(ParseContext.class));
        mw.visitFieldInsn(PUTFIELD, ASMUtils.type(com.chua.agent.support.json.parser.DefaultJSONParser.ResolveTask.class), "ownerContext", ASMUtils.desc(ParseContext.class));
        ...
        mw.visitFieldInsn(PUTFIELD, ASMUtils.type(com.chua.agent.support.json.parser.DefaultJSONParser.ResolveTask.class), "fieldDeserializer", ASMUtils.desc(FieldDeserializer.class));

        mw.visitVarInsn(ALOAD, 1);
        mw.visitLdcInsn(com.chua.agent.support.json.parser.DefaultJSONParser.NONE);
    ...
    private void _deserObject(Context context, MethodVisitor mw, FieldInfo fieldInfo, Class<?> fieldClass, int i) {
        ...
        if ((fieldInfo.parserFeatures & Feature.SupportArrayToBean.mask) != 0) {
            ...
            if (fieldInfo.fieldType instanceof Class) {
                mw.visitLdcInsn(com.chua.agent.support.json.asm.Type.getType(ASMUtils.desc(fieldInfo.fieldClass)));
            } else {
                mw.visitVarInsn(ALOAD, 0);
                mw.visitLdcInsn(i);
                mw.visitMethodInsn(INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "getFieldType",
    ...
    private void _getFieldDeser(Context context, MethodVisitor mw, FieldInfo fieldInfo) {
        Label notNull_ = new Label();
        mw.visitVarInsn(ALOAD, 0);
        mw.visitFieldInsn(GETFIELD, context.className, context.fieldDeserName(fieldInfo), ASMUtils.desc(ObjectDeserializer.class));
        mw.visitJumpInsn(IFNONNULL, notNull_);
        ...
        mw.visitFieldInsn(PUTFIELD, context.className, context.fieldDeserName(fieldInfo), ASMUtils.desc(ObjectDeserializer.class));
