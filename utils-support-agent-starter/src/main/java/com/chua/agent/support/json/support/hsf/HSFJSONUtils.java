package com.chua.agent.support.json.support.hsf;
...
import static com.chua.agent.support.json.parser.JSONLexer.NOT_MATCH_NAME;
    ...
    public static Object[] parseInvocationArguments(String json, MethodLocator methodLocator) {
        ...
        if (token == JSONToken.LBRACE) {
            ...
            if (typeNames == null && lexer.matchStat == NOT_MATCH_NAME) {
                ...
                if ("com.chua.agent.support.json.JSONObject".equals(type)) {
