...
//        img = img.resize((resizedWidth, resizedHeight), Image.LANCZOS)
        ...
        NDArray mean =
                ctx.getNDManager().create(new float[]{0.485f, 0.456f, 0.406f}, new Shape(3, 1, 1)).getNDArrayInternal().getArray();
        NDArray std =
                ctx.getNDManager().create(new float[]{0.229f, 0.224f, 0.225f}, new Shape(3, 1, 1)).getNDArrayInternal().getArray();
