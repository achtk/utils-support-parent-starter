...
public class SoundUtils {
     ...
     * @throws Exception ex
     */
    public static void saveWavFile(NDArray wav, float volume, OutputStream outs) throws Exception {
    ...
    public static void save(float[] buffer, double sampleRate, int channels, OutputStream outs)
            throws Exception {
        ...
        for (int i = 0; i < byteBuffer.length; i++) {
            // * 32767.0
            final int x = (int) (buffer[bufferIndex++]);
